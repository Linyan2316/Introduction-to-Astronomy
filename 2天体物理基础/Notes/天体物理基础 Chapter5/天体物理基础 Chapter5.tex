...
\begin{equation}
\rho\frac{\d\symbf{v}}{\d{}t}+\rho\nabla\symbf{\Phi}=-\nabla\symbf{P}+\frac{1}{4\pi}\left(\nabla\times\symbf{B}\right)\times\symbf{B}+\rho\symbf{F}_{\mathrm{rad}}.
\end{equation}
...
因此温度
\begin{equation}
T=\left(\frac{\symup{G}M\dot{m}}{8\pi\sigma}\right)^{\frac{1}{4}}r^{-\frac{3}{4}}.
\end{equation}
