...
\begin{equation}
\rho\frac{\d\symbf{v}}{\d{}t}+\rho\nabla\symbf{\Phi}=-\nabla\symbf{P}+\frac{1}{4\pi}\left(\nabla\times\symbf{B}\right)\times\symbf{B}+\rho\symbf{F}_{\symup{rad}}.
\end{equation}
...
\frac{h}{r}&=\frac{\symup{c}_{\symup{s}}}{\sqrt\dfrac{\symup{G}M}{r}}.
\end{align}
...
对于没有自旋的黑洞而言，
\begin{equation}
r_{\min}=3R_{\symup{s}}=\frac{6\symup{G}M}{\symup{c}^{2}}, L=\frac{1}{12}\dot{m}\symup{c}^{2}.
\end{equation}
...
\begin{equation}
I_{\nu}\propto{}v^{\frac{1}{3}}\int_{r_{\min}}^{r_{\max}}x^{\frac{4}{3}}\left[\exp\left(\frac{h\nu}{k_{\symup{B}}T}\right)-1\right]^{-1}x^{\frac{1}{3}}\d{}x.
\end{equation}

Eddington 光度 $L=\dfrac{4\pi\symup{c}\symup{G}Mm_{\ce{p}}}{\sigma_{\symup{T}}}$ 给定了最大吸积速率。
\begin{equation}
\frac{\dot{m}}{M}=\frac{4\pi\symup{c}\symup{G}m_{\ce{p}}}{\varepsilon_{\symup{L}}\sigma_{\symup{T}}\symup{c}^{2}}.
\end{equation}
由此给定了黑洞吸积时标
\begin{equation}
\tau_{\symup{s}}=\varepsilon_{\symup{L}}\frac{\sigma_{\symup{T}}\symup{c}^{2}}{4\pi\symup{c}\symup{G}m_{\ce{p}}}.
\end{equation}
