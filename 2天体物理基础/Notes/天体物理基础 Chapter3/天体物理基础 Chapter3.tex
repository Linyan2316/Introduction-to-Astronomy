...
星云质量足够高时，引力超过热运动提供的压力，就会引起星云坍缩。极限质量被称为金斯质量。动能 $\symup{K}=\dfrac{3}{2}N\symup{k}_{\mathrm{B}}T$, 势能 $\symup{U}\sim-\dfrac{3}{5}\dfrac{\symup{G}M^{2}}{R}, 2\symup{K}<\mleft\vert\symup{U}\mright\vert$ 时星云坍缩。
...
\end{equation}
其中转动惯量 $I=\int\rho\mleft\vert\symbf{r}\mright\vert^{2}\d{}^{3}x$, 动能 $T=\dfrac{1}{2}\int\rho\mleft\vert\symbf{u}\mright\vert^{2}\d{}^{3}x$, 热能 $U=\dfrac{3}{2}\int n\symup{k}_{\mathrm{B}}T\d{}^{3}x$, 引力势能 $W=\dfrac{1}{2}\int\rho\phi_{g}\d{}^{3}x$, 磁能 $M=\dfrac{1}{8\pi}\int\mleft\vert\symbf{B}\mright\vert^{2}\d{}^{3}x$.
