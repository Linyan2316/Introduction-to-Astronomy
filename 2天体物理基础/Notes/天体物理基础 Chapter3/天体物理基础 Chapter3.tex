...
星云质量足够高时，引力超过热运动提供的压力，就会引起星云坍缩。极限质量被称为金斯质量。动能$\text{K}=\dfrac{3}{2}Nk_{\text{B}}T$，势能$\text{U}\sim-\dfrac{3}{5}\dfrac{\symup{G}M^{2}}{R},2\text{K}<\left\vert{}\text{U}\right\vert{}$时星云坍缩。
