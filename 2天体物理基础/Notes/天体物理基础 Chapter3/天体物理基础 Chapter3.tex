...
\cline{1-3}
温度 & $\qty{20}{K},\qty{100}{K},\qty{e4}{K},\ce{H2},\ce{H}\,\mathrm{\uppercase\expandafter{\romannumeral1}},\ce{H}\,\mathrm{\uppercase\expandafter{\romannumeral2}}$ & $10\text{\textendash}\qty{20}{K}$\\
\cline{1-3}
...
星际气体 $n\in\mleft(10^{-3}, 10^{3}\mright)\,\unit{cm^{-3}}, T\in\mleft(10, 10^{7}\mright)\,\unit{K}$, 因此星际气体的压强基本上是相同的。气体平均密度 $\qty{1}{cm^{-3}}$, 尘埃数密度 $\qty{e-13}{cm^{-3}}$.
...
\hline
成分 & 观测证据 & 温度 ($\unit{K}$) & 数密度 ($\qty{}{cm^{-3}}$) & 质量百分比\\
\cline{1-5}
...
\subsubsection{电离氢气体}
发射星云：被高温恒星的紫外辐射电离的星际物质，也被称为 $\ce{H}\,\mathrm{\uppercase\expandafter{\romannumeral2}}$ 区。具有容许和禁戒发射线，颜色偏红，典型温度 $\sim\qty{8000}{K}$. 比如 O, B 型年轻恒星附近被紫外光子解离的气体形成的斯特龙根球。
...
\begin{equation}
M_{\ce{H}\,\mathrm{\uppercase\expandafter{\romannumeral1}}}=2.3\times10^{5}\mleft(1+z\mright)\mleft(\frac{D_{\mathrm{L}}}{\unit{Mpc}}\mright)^{2}\mleft(\frac{F}{\unit{Jy\cdot km\cdot s^{-1}}}\mright)\,\unit{M_{\odot}}.
\end{equation}
...
分子云占据银盘内大约 $1\%$ 的空间，质量大约占星际气体总质量的 $50\%$. 银河系中 $M_{\ce{H}}\sim\mleft(4\text{\textendash}8\mright)\times\qty{e9}{M_{\odot}}, M_{\ce{H2}}=\dfrac{1}{2}M_{\ce{H}}$.
...
旋涡星系中，致密分子气体、尘埃、年轻恒星主要集中在星系的旋臂区域。银河系中，分子氢主要分布在 $R<R_{0}$ 区域，中性氢分布范围更高更广（甚至比恒星更延伸），但星系中心数百秒差距内没有分子氢和中性氢。

在星际云间的空间中也存在气体。主要有中性的稀薄气体和更稀薄的热气体 ($\qty{e4}{K}$).
...
\begin{equation}
\log E\mleft(\lambda\mright)\sim\frac{1}{\lambda}.
\end{equation}
...
为简化模型，我们假设星系气体总是充分混合，恒星聚变产物瞬时返回星际介质，没有任何气体从星系逃离也没有任何气体流入。记时刻 $t$ 的气体质量为 $M_{\mathrm{g}}\mleft(t\mright)$, 金属丰度为 $Z\mleft(t\mright)$, 低质量恒星（寿命太长，产物在可预见的时标内不会返回到星际空间中）和大质量恒星遗迹（中子星、黑洞等，重元素被“锁”在其中也无法返回星际介质）的质量为 $M_{*}\mleft(t\mright)$, 从恒星中返回星际介质的气体金属丰度为 $p$.

现在有 $\laplacian{}M_{\mathrm{g}}'\mleft(t\mright)$ 的气体形成恒星，同时有 $\laplacian{}M_{\mathrm{g}}''\mleft(t\mright)$ 的气体返回星际介质，因此 $\laplacian{}M_{\mathrm{g}}\mleft(t\mright)=\laplacian{}M_{\mathrm{g}}''\mleft(t\mright)-\laplacian{}M_{\mathrm{g}}'\mleft(t\mright)$, 同时 $\laplacian{}M_{*}\mleft(t\mright)=-\laplacian{}M_{\mathrm{g}}\mleft(t\mright)$ 的气体留在恒星遗迹中。星际介质金属丰度的变化为
\begin{equation}
\laplacian{}Z=Z'-Z\approx\frac{ZM_{\mathrm{g}}-Z\laplacian{}M_{\mathrm{g}}'+p\laplacian{}M_{\mathrm{g}}''}{M_{\mathrm{g}}}-Z=\frac{p\laplacian{}M_{\mathrm{g}}}{M_{\mathrm{g}}}.
\end{equation}

如果 $p$ 不依赖于金属丰度，那么
\begin{equation}
\frac{\laplacian{}Z}{p}=-\frac{\laplacian{}M_{\mathrm{g}}}{M_{\mathrm{g}}}.
\end{equation}
因此气体金属丰度随时间增加
\begin{equation}
Z\mleft(t\mright)=Z_{0}+p\ln\mleft[\frac{M_{\mathrm{g}0}}{M_{\mathrm{g}}}\mright].
\end{equation}
$M_{\mathrm{g}0}-M_{\mathrm{g}}$ 是已经转化成恒星的气体质量，因此金属丰度小于一定值 $Z$ 的恒星质量为
\begin{equation}
M\mleft(<Z\mright)=M_{\mathrm{g}0}\mleft(1-\symup{e}^{-\frac{Z-Z_{0}}{p}}\mright).
\end{equation}
金属丰度在 $Z$ 和 $Z+\laplacian{}Z$ 之间恒星的质量为
\begin{equation}
\frac{\d{}M_{*}}{\d{}Z}\laplacian{}Z\propto\exp\mleft\{-\mleft[Z-Z_{0}/p\mright]\laplacian{}Z\mright\}.
\end{equation}
...
星云质量足够高时，引力超过热运动提供的压力，就会引起星云坍缩。极限质量被称为金斯质量。动能 $\symup{K}=\dfrac{3}{2}Nk_{\mathrm{B}}T$, 势能 $\symup{U}\sim-\dfrac{3}{5}\dfrac{\symup{G}M^{2}}{R}, 2\symup{K}<\mleft\vert\symup{U}\mright\vert$ 时星云坍缩。
...
无粘性流体的运动方程为：
\begin{align}
\rho\frac{\d\symbf{u}}{\d{}t}&=-\nabla{}P-\rho\nabla\phi_{g}+\frac{1}{\symup{c}}\symbf{J}\times\symbf{B}.\\
\rho\frac{\d\symbf{u}}{\d{}t}&=-\nabla P-\rho\nabla\phi_{g}+\frac{1}{4\pi}\mleft(\symbf{B}\cdot\nabla \symbf{B}\mright)-\frac{1}{8\pi}\nabla\mleft\vert\symbf{B}\mright\vert^{2}.
\end{align}
不考虑外界压强，即自引力主导下，方程转化为
\begin{equation}
\frac{1}{2}\frac{\partial{}^{2}I}{\partial{}t^{2}}=2T+2U+W+M,
\end{equation}
其中转动惯量 $I=\int\rho\mleft\vert\symbf{r}\mright\vert^{2}\d{}^{3}x$, 动能 $T=\dfrac{1}{2}\int\rho\mleft\vert\symbf{u}\mright\vert^{2}\d{}^{3}x$, 热能 $U=\dfrac{3}{2}\int nk_{\mathrm{B}}T\d{}^{3}x$, 引力势能 $W=\dfrac{1}{2}\int\rho\phi_{g}\d{}^{3}x$, 磁能 $M=\dfrac{1}{8\pi}\int\mleft\vert\symbf{B}\mright\vert^{2}\d{}^{3}x$.

气体云在引力坍缩时，$\dfrac{1}{2}\dfrac{\partial{}^{2}I}{\partial{}t^{2}}\approx-\dfrac{\symup{G}M^{2}}{R}$. 坍缩时标
\begin{equation}
t_{\mathrm{ff}}\sim\mleft(\frac{1}{4\pi\symup{G}\rho}\mright)^{\frac{1}{2}}\sim5\times10^{5}\mleft(\frac{n}{\qty{e4}{cm^{-3}}}\mright)^{-\frac{1}{2}}\,\unit{yr}.
\end{equation}
...
\begin{equation}
\xi\mleft(m\mright)\d{}m=\xi_{0}m^{-\alpha}\d{}m,
\end{equation}
...
坍缩时标
\begin{equation}
\frac{\d{}^{2}r}{\d{}t^{2}}=-\frac{\symup{G}M_{r}}{r^{2}}\to t_{\mathrm{ff}}=\mleft(\frac{3\pi{}}{32\symup{G}\rho}\mright)^{\frac{1}{2}}.
\end{equation}
...
小质量恒星形成模型的放大版本，$M_{\mathrm{J}}>\qty{10}{M_{\odot}}$, 辐射加热或湍动、磁场主导内部压力。但是湍动作用未知，尚未观测到大质量恒星前核。

2. 竞争吸积

$M_{\mathrm{J}}\sim\qty{0.5}{M_{\odot}}$, 处于引力优势位置的原恒星更容易通过吸积周围的气体生长，但这样提供的恒星形成效率低。
...
O, B 型恒星表面温度高能产生大量紫外 ($\lambda<\qty{912}{\angstrom}$) 光子电离氢，产生 $\ce{H}\,\mathrm{\uppercase\expandafter{\romannumeral2}}$ 区。如斯特龙根球就是年轻 O, B 型恒星周围存在的电离氢区。光致电离产生的大量自由电子之间相互频繁碰撞，建立电子气的平衡态速度分布。
