...
现在有 $\laplacian{}M_{\text{g}}'\left(t\right)$ 的气体形成恒星，同时有 $\laplacian{}M_{\text{g}}''\left(t\right)$ 的气体返回星际介质，因此 $\laplacian{}M_{\text{g}}\left(t\right)=\laplacian{}M_{\text{g}}''\left(t\right)-\laplacian{}M_{\text{g}}'\left(t\right)$, 同时 $\laplacian{}M_{*}\left(t\right)=-\laplacian{}M_{\text{g}}\left(t\right)$ 的气体留在恒星遗迹中。星际介质金属丰度的变化为
\begin{equation}
\laplacian{}Z=Z'-Z\approx\frac{ZM_{\text{g}}-Z\laplacian{}M_{\text{g}}'+p\laplacian{}M_{\text{g}}''}{M_{\text{g}}}-Z=\frac{p\laplacian{}M_{\text{g}}}{M_{\text{g}}}.
\end{equation}

如果 $p$ 不依赖于金属丰度，那么
\begin{equation}
\frac{\laplacian{}Z}{p}=-\frac{\laplacian{}M_{\text{g}}}{M_{\text{g}}}.
\end{equation}
因此气体金属丰度随时间增加
\begin{equation}
...
坍缩时标
\begin{equation}
\frac{\d{}^{2}r}{\d{}t^{2}}=-\frac{\symup{G}M_{r}}{r^{2}}\to t_{\text{ff}}=\left(\frac{3\pi{}}{32\symup{G}\rho}\right)^{\frac{1}{2}}.
\end{equation}
