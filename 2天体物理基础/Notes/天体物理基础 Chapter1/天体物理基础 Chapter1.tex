...
\draw [red](103.74,144.71) -- (517.57,91.1);
\draw [shift={(519.55,90.84)}, rotate = 172.62] [color={rgb, 255:red, 255; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29);
%Straight Lines [id:da3285717001142934] 
\draw [red](103.74,144.71) -- (487.54,203);
\draw [shift={(489.52,203.3)}, rotate = 188.64] [color={rgb, 255:red, 255; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29);
...
\draw [red](237.47,127.5) .. controls (242.94,127.41) and (247.51,135.51) .. (247.67,145.58) .. controls (247.83,155.65) and (243.53,163.89) .. (238.06,163.98) .. controls (232.58,164.07) and (228.02,155.97) .. (227.86,145.9) .. controls (227.69,135.82) and (232,127.59) .. (237.47,127.5) -- cycle;
...
\end{pmatrix}
=\begin{pmatrix}
\gamma(\dfrac{\partial}{\partial z'}-\dfrac{\beta}{\symup{c}}\dfrac{\partial}{\partial t'})\\
\dfrac{\partial}{\partial x'}\\
\dfrac{\partial}{\partial y'}\\
\dfrac\gamma{i\symup{c}}(\dfrac{\partial}{\partial t'}-\symup{c}\beta\dfrac{\partial}{\partial z'})\\
\end{pmatrix},
\end{equation}
\begin{equation}
...
\end{equation}
取$t\left(a\right)=0$,即从宇宙诞生时刻算起，计算光子共动距离，再乘以现在的尺度因子$a_{0}$就得到现在的视界
\begin{equation}
d_{\text{H}}=a_{0}\int_{0}^{t_{0}}\frac{\symup{c}\symup{d}t}{a\left(t\right)}=a_{0}\int_{0}^{\infty}\frac{\symup{c}\symup{d}z}{H\left(z\right)}.
\end{equation}
