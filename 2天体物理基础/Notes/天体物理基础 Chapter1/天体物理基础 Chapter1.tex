...
定义配分函数
\begin{equation}
U_{r}\left(T\right)=\sum_{i=1}^{\infty}g_{r, i}\symup{e}^{-\frac{\varepsilon_{r, i}}{k_{\text{B}}T}},
\end{equation}
可以得到
\begin{equation}
N_{r}=\frac{N_{r, 1}}{g_{r, 1}}U_{r}\left(T\right)=\frac{N_{r, k}}{g_{r, k}}\symup{e}^{\frac{\varepsilon_{r, k}}{k_{\text{B}}T}}U_{r}\left(T\right).
\end{equation}
...
同时粒子数分布满足玻尔兹曼公式，得到
\begin{align}
A_{ki}+B_{ki}I_{\nu}&=\frac{g_{i}}{g_{k}}\symup{e}^{-\frac{\varepsilon_{i}-\varepsilon_{k}}{k_{\text{B}}T}}B_{ik}I_{\nu},\\
...
\begin{align}
\frac{N_{k}}{N_{i}}&=\frac{b_{k}}{b_{i}}\frac{g_{k}}{g_{i}}\symup{e}^{-\frac{\varepsilon_{i}-\varepsilon_{k}}{k_{\text{B}}T}},\\
...
对频率积分可以得到总能量密度：
\begin{equation}
U=\int\varepsilon\left(\nu\right)\symup{d}\nu=\frac{8\pi h}{\symup{c}^{3}}\int\frac{\nu^{3}\symup{d}\nu}{\symup{e}^{\frac{h\nu}{k_{\text{B}}T}}-1}=\frac{8\pi}{\symup{c}^{3}}\frac{k_{\text{B}}^{4}T^{4}}{h^{3}}\int\frac{x^{3}\symup{d}x}{\symup{e}^{x}-1}=\frac{8\pi^{5}k_{\text{B}}^{4}}{15h^{3}\symup{c}^{3}}T^{4}=a_{\text{B}}T^{4}.
\end{equation}
