...
\begin{align}
\varepsilon_{\text{Feimi}}&=\frac{P_{\text{F}}^{2}}{2m_{\ce{n}}}=\frac{h^{2}}{2m_{\ce{n}}}\left(\frac{3n}{8\pi}\right)^{\frac23}=\qty{30}{MeV}\left(\frac{\rho}{\qty{e14}{g\cdot cm^{-3}}}\right)^{\frac{2}{3}}\gg k_{\text{B}}T.\\
