...
\begin{align}
\d{}U_{\symup{g}, i}&=-\symup{G}\frac{M_{r}\d{}m_{i}}{r},\notag\\
U_{\symup{g}}&=-\symup{G}\int_{0}^{R}\frac{4}{3}\pi r^{3}\rho \frac{4\pi r^{2}\rho\d{}r}{r}\notag\\
...
\begin{align}
\frac{1}{2}m_{\ce{H}}v^{2}&=\frac{3}{2}k_{\symup{B}}T_{\symup{classical}}=\frac{1}{4\pi\varepsilon_{0}}\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}}{r},\\
T_{\symup{classical}}&=\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}}{6\pi\varepsilon_{0}k_{\symup{B}}r}\sim\qty{e10}{K}.
\end{align}
...
T_{\symup{quantum}}&=\frac{Z_{1}^{2}Z_{2}^{2}{\color{blue}{\ce{e}}}^{4}m_{\ce{H}}}{12\pi^{2}\varepsilon_{0}^{2}k_{\symup{B}}h^{2}}\sim\qty{e7}{K}.
\end{align}
...
\end{equation}
因此太阳平均温度可达 $T=\dfrac{\mu m_{\ce{H}}\overline{P}}{k_{\symup{B}}\rho}\sim\qty{5e6}{K}$, 核心温度可达 $\qty{1.5e7}{K}$, 因此仅凭借云团坍缩过程中所释放的引力能就足以达到支持热核反应所需要的高温。
...
首先 Maxwell 速度分布为
\begin{align}
f\left(v\right)\d{}v&=\left(\frac{m}{2\pi k_{\symup{B}}T}\right)^{\frac{3}{2}}\exp\left(-\frac{mv^{2}}{2k_{\symup{B}}T}\right)4\pi v^{2}\d{}v,\\
f\left(E\right)\d{}E&=\frac{2}{\sqrt{\pi}}\frac{E^{\frac{1}{2}}}{\left(k_{\symup{B}}T\right)^{\frac{3}{2}}\exp\left(-\dfrac{E}{k_{\symup{B}}T}\right)}\d{}E.
\end{align}
...
\begin{align}
\sigma\left(E\right)&=\frac{S\left(E\right)}{E}\exp\left[-\frac{E_{\symup{G}}^{\frac{1}{2}}}{E^{\frac{1}{2}}}\right],\\
E_{\symup{G}}&=\left[\frac{1}{2\varepsilon_{0}\hbar}\left(\frac{m}{2}\right)^{\frac{1}{2}}Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}\right]^{2},
\end{align}
结合 Maxwell 速度分布就能得到反应速率：
\begin{align}
r&=n_{1}n_{2}\int_{0}^{\infty}\sigma\left(E\right)vf\left(E\right)\d{}E\notag\\
&=n_{1}n_{2}\frac{2^{\frac{3}{2}}}{\left(\pi m\right)^{\frac{1}{2}}}\frac{1}{\left(k_{\symup{B}}T\right)^{\frac{3}{2}}}\int_{0}^{\infty}S\left(E\right)\exp\left(-\frac{E_{\symup{G}}^{\frac{1}{2}}}{E^{\frac{1}{2}}}\right)\exp\left(-\frac{E}{k_{\symup{B}}T}\right)\d{}E.
\end{align}
观察上式可知在某个能量处反应速率最大，也就是 Gamow Peak:
\begin{equation}
E_{0}=\left[\left(\frac{m}{2}\right)^{\frac{1}{2}}\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}k_{\symup{B}}T}{4\varepsilon_{0}\hbar}\right]^{\frac{2}{3}}=\left(\frac{E_{\symup{G}}^{\frac{1}{2}}k_{\symup{B}}T}{2}\right)^{\frac{2}{3}}.
\end{equation}
看表达式可知 $E_{0}$ 是热能 $k_{\symup{B}}T$ 和 $E_{\symup{G}}$ 按照 $2: 1$ 的几何平均。
...
\begin{equation}
r\propto{}n_{1}n_{2}\frac{S\left(E_{0}\right)}{T^{\frac{2}{3}}}\exp\left[-3\left(\frac{{\color{blue}{\ce{e}}}^{4}}{32\varepsilon_{0}^{2}k_{\symup{B}}\hbar^{2}}\frac{mZ_{1}^{2}Z_{2}^{2}}{T}\right)^{\frac{1}{3}}\right].
\end{equation}

于是我们可以定义聚变效率 $C$, 一般用实验而不是计算确定。最后可借此得到单位体积的能量产生率 $\varepsilon$
\begin{align}
r\laplacian\varepsilon&=\rho\varepsilon.\\
&\varepsilon=C\rho X_{1}X_{2}\frac{1}{T^{\frac{2}{3}}}\exp\left[-3\left(\frac{{\color{blue}{\ce{e}}}^{4}}{32\varepsilon_{0}^{2}k_{\symup{B}}\hbar^{2}}\frac{mZ_{1}^{2}Z_{2}^{2}}{T}\right)^{\frac{1}{3}}\right].
\end{align}

\subsubsection{恒星中的聚变过程}
氢核聚变是最为常见的热核反应，其核反应方程式为
\begin{equation}
\ce{4{}^{1}H ->{}^{4}He +2{\color{blue}{\ce{e}}}^{+}}+2\nu_{{\color{blue}{\ce{e}}}}+\symup{energy}.
\end{equation}
...
\end{equation}
对于理想气体而言，气压 $P=nk_{\symup{B}}T$, 内能 $E_{\symup{T}}=\dfrac{3}{2}nk_{\symup{B}}T$, 因此 $3P=2E_{\symup{T}}$, 上式积分左侧结果为 $-2U_{\symup{T}}$, 而右侧正是引力能 $U_{\symup{g}}$, 因此恒星总能量为 $U_{\symup{total}}=U_{\symup{T}}+U_{\symup{g}}=\dfrac{1}{2}U_{\symup{g}}=-U_{\symup{T}}$, 恒星温度升高，动能上高，总能量反而下降，因此恒星是个负热容系统。

而对相对论物质来说，因为 $E_{\symup{T}}=3P$, 因此 $U_{\symup{T}}=-U_{\symup{g}}$, 因此总能量为 $0$.

\subsubsection{恒星的压力来源}
恒星内部的压力来源主要有三种：气体运动产生的气压 $P_{\symup{g}}$, 光子辐射压 $P_{\symup{rad}}$ 以及粒子简并压。

首先考虑非简并气体。我们在介绍质光关系的时候就计算过它们的辐射压：
\begin{equation}
P_{\symup{rad}}=\frac{1}{3}a_{\symup{B}}T^{4}.
\end{equation}
而对于气压，我们假设非简并气体状态方程为理想气体状态方程
\begin{equation}
P_{\symup{g}}=nk_{\symup{B}}T,
\end{equation}
其中 $n$ 是粒子数密度。记气体一共包含 $n'$ 摩尔的分子，那么
\begin{equation}
n=\frac{n'N_{\symup{A}}}{V}=\frac{n'N_{\symup{A}}}{\dfrac{m}{\rho}}=\frac{\rho}{\dfrac{m}{n'N_{\symup{A}}}}=\frac{\rho}{\mu m_{\ce{H}}},
\end{equation}
其中 $N_{\symup{A}}$ 是阿伏伽德罗常数，$\mu$ 为平均相对分子质量，$m_{\ce{H}}$ 是质子的实际质量，数值上等于 $\dfrac{1}{N_{\symup{A}}}$. 故非简并理想气体的气压可以写作
\begin{equation}
P_{\symup{g}}=\frac{\rho k_{\symup{B}}T}{\mu m_{\ce{H}}}.
\end{equation}
...
\begin{equation}
P_{\symup{g}}=n_{{\color{blue}{\ce{e}}}}k_{\symup{B}}T+\sum_{i}n_{i}k_{\symup{B}}T=\sum_{i}\left(Z_{i}+1\right)n_{i}k_{\symup{B}}T=\sum_{i}\left(1+Z_{i}\right)\frac{\rho\chi_{i}k_{\symup{B}}T}{A_{i}m_{\ce{H}}}=\frac{\rho k_{\symup{B}}T}{\mu m_{\ce{H}}}.
\end{equation}
因此相对分子量为
\begin{equation}
...
\begin{equation}
P_{\symup{g}}=\rho k_{\symup{B}}T\frac{2X+\dfrac{3}{4}Y+\dfrac{1}{2}Z}{m_{\ce{H}}}.
\end{equation}

有时候我们不考虑电子气体的贡献，即只有一大堆离子，那么
\begin{align}
\frac{1}{\mu}&=\sum_{i}\frac{\chi_{i}}{A_{i}}\\
P_{\symup{g}}&=\rho k_{\symup{B}}T\frac{X+\dfrac{1}{4}Y}{m_{\ce{H}}}.
\end{align}
...
\end{equation}
假设动量有个最高限制 $p_{\symup{F}}$, 积分可以得到电子数密度：
\begin{equation}
n_{{\color{blue}{\ce{e}}}}=\int_{0}^{p_{\symup{F}}}\frac{8\pi}{h^{3}}p^{2}\d{}p=\frac{8\pi}{3h^{3}}p_{\symup{F}}^{3},
\end{equation}
那么反过来讲，已知电子数密度就知道了动量的最高分布，可借此确定积分限，代入 (\ref{2.1.37}) 式得到
\begin{equation}
P=\frac{1}{3}\int_{0}^{p_{\symup{F}}}vp\frac{2}{h^{3}}4\pi p^{2}\d{}p.
\end{equation}
根据狭义相对论，$v=\dfrac{p}{\gamma m}=\dfrac{p\symup{c}^{2}}{\sqrt{p^{2}\symup{c}^{2}+m^{2}\symup{c}^{4}}}$, 于是有
\begin{equation}
P=\frac{8\pi}{3}\int_{0}^{p_{\symup{F}}}\frac{p^{4}\symup{c}^{2}}{\sqrt{p^{2}\symup{c}^{2}+m^{2}\symup{c}^{4}}}\d{}p.\label{2.1.46}
\end{equation}
...
因此费米动量可以表示为
\begin{equation}
p_{\symup{F}}=\left(\frac{3h^{3}\rho}{8\pi\mu_{{\color{blue}{\ce{e}}}}m_{\ce{H}}}\right)^{\frac{1}{3}}.
\end{equation}
相对论情况下，(\ref{2.1.46}) 式结果为
\begin{equation}
P=\frac{8\pi}{15h^{3}m_{{\color{blue}{\ce{e}}}}}p_{\symup{F}}^{5}=\frac{3^{\frac{2}{3}}}{20\pi^{\frac{2}{3}}}\frac{h^{2}}{m_{{\color{blue}{\ce{e}}}}}n_{{\color{blue}{\ce{e}}}}^{\frac{5}{3}}.
\end{equation}
非相对论情况下，
\begin{equation}
P=\frac{2\pi\symup{c}}{3h^{3}}p_{\symup{F}}^{4}=\frac{3^{\frac{1}{3}}}{8\pi^{\frac{1}{3}}}h\symup{c}n_{{\color{blue}{\ce{e}}}}^{\frac{4}{3}}.
\end{equation}
...
再根据斯特藩玻尔兹曼方程得到
\begin{align}
U&=a_{\symup{B}}T^{4}, F=\frac{\symup{c}a_{\symup{B}}}{4}T_{\symup{eff}}^{4},\\
T^{4}&=\frac{3}{4}T_{\symup{eff}}^{4}\left(\tau+\frac{2}{3}\right).\\
...
\begin{equation}
\frac{\d{}T}{\d{}r}=\left.\frac{\d{}T}{\d{}r}\right\vert_{\symup{rad}}+\left.\frac{\d{}T}{\d{}r}\right\vert_{\symup{conv}}.
\end{equation}

首先考虑辐射部分。其实我们已经推导过了，在介绍 Eddington 光度时就考虑过辐射压和引力的平衡，在推导质光关系时将其扩展得到
\begin{equation}
\frac{\symup{G}M}{r^{2}}=\frac{1}{\rho}\frac{\d{}P}{\d{}r}=\frac{1}{\symup{c}}\kappa\frac{L}{4\pi r^{2}}=\frac{1}{\rho}\frac{4}{3}a_{\symup{B}}T^{3}\frac{\d{}T}{\d{}r},\tag{\ref{1.4.11}}
\end{equation}
稍作整理并修正下正负号便是所需要的方程
\begin{equation}
\frac{\d{}T}{\d{}r}=-\frac{3}{4a_{\symup{B}}\symup{c}}\frac{\kappa\rho}{T^{3}}\frac{L_{r}}{4\pi r^{2}}.\label{2.1.68}
\end{equation}
...
\end{equation}
定义 Rosseland Mean $\alpha_{\symup{R}}=\dfrac{\int\dfrac{\d{}P_{\nu}}{\d{}z}d\nu}{\int\dfrac{1}{\alpha_{\nu}}\dfrac{\d{}P_{\nu}}{\d{}z}d\nu}$, 得到
\begin{equation}
F=-\frac{\symup{c}}{\alpha_{\symup{R}}}\frac{\d{}P}{\d{}z},
\end{equation}
压力和黑体谱也有关联 ($P_{\nu}=\dfrac{4\pi}{3\symup{c}}B_{\nu}\left(\tau_{\nu}\right)$), 所以
\begin{align}
\frac{\d{}P_{\nu}}{\d{}z}&=\frac{4\pi}{3\symup{c}}\frac{\partial{}B_{\nu}}{\partial{}T}\frac{\d{}T}{\d{}z}.\\
\frac{1}{\alpha_{\symup{R}}}&=\frac{\int\dfrac{1}{\alpha_{\nu}}\dfrac{\partial{}B_{\nu}}{\partial{}T}\d\nu}{\int\dfrac{\partial{}B_{\nu}}{\partial{}T}\d\nu}.
\end{align}
再考虑到压强和内能和温度的关系，最后得到
\begin{equation}
F=-\frac{\symup{c}}{\alpha_{\symup{R}}}\frac{\d{}}{\d{}z}\left(\frac{a_{\symup{B}}}{3}T^{4}\right).
\end{equation}
最后由于 $\alpha_{\symup{R}}=\rho\kappa, L_{r}=4\pi{}r^{2}F$,
\begin{equation}
\frac{\d{}T}{\d{}r}=-\frac{3}{4a_{\symup{B}}\symup{c}}\frac{\rho\kappa}{T^{3}}\frac{L_{r}}{4\pi{}r^{2}}.
\end{equation}
...
\left.\frac{\d{}T}{\d{}r}\right\vert_{\symup{ad}}&=\left(1-\frac{1}{\gamma}\right)\frac{T}{P}\frac{\d{}P}{\d{}r}=-\left(1-\frac{1}{\gamma}\right)\frac{\mu m_{\ce{H}}}{k_{\symup{B}}}\frac{\symup{G}M_{r}}{r^{2}}.
\end{align}
我们认为 $\left\vert\dfrac{\d{}T}{\d{}r}\right\vert_{\symup{actual}}<\left\vert\dfrac{\d{}T}{\d{}r}\right\vert_{\symup{ad}}$ 的是辐射区，反之是对流区。
...
接着作代换
\begin{align}
\rho\left(r\right)&=\rho_{\symup{c}}\left[\theta_{n}\left(r\right)\right]^{n},\\
r&=a_{n}\xi\left(r\right),\\
a_{n}&=\left[\frac{\left(n+1\right)K}{4\pi\symup{G}}\rho_{\symup{c}}^{\frac{1}{n}-1}\right]^{\frac{1}{2}},\label{2.1.86}
\end{align}
其中 $\rho_{\symup{c}}$ 代表恒星中心的密度，如此一来 (\ref{2.1.33}) 式可以改写为 Lane-Emden 方程的形式：
\begin{equation}
...
不过实际情况 $n$ 可能无法取这三个正整数。此时要用到 scaling relation. 对于 $n<5$ 的情况，总存在一个半径 $R=a\xi_{1}$, 在此处 $\rho=0$. 对于相同的 $n$, 无论物体成分如何，其无量纲数 $\xi_{1}$ 总是一致的。根据 (\ref{2.1.86}) 式，对于给定的 $n$, $R\propto\rho_{\symup{c}}^{\frac{1-n}{2n}}$. 总质量满足
\begin{equation}
M=\int_{0}^{R}4\pi{}r^{2}\rho\d{}r=4\pi{}a^{3}\rho_{\symup{c}}\int_{0}^{\xi_{1}}\xi^{2}\theta^{n}\d\xi,
\end{equation}
因此对于给定的 $n$, $M\propto{}a^{3}\rho_{\symup{c}}\propto\rho_{\symup{c}}^{\frac{3-n}{2n}}$. 因此可得 $R\propto{}M^{\frac{1-n}{3-n}}$. 非相对论情况，$n=\dfrac{3}{2}, R\propto{}M^{-\frac{1}{3}}$, 白矮星吸积物质，质量逐渐增大，反而逐渐收缩，然后升温。一直到相对论情况，$n=3, R\propto{}M^{-\infty}$, 直接坍缩。
...
\begin{equation}
t_{\symup{the}}=0.5\frac{\symup{G}M^{2}}{RL}\approx\qty{2e7}{yr}\left(\frac{M}{\unit{M_{\odot}}}\right)^{2}\left(\frac{R}{\unit{R_{\odot}}}\right)^{-1}\left(\frac{L}{\unit{L_{\odot}}}\right)^{-1}.
\end{equation}

动力学时标，如果恒星内部压力突然消失，引力作用下恒星坍缩的时间
\begin{equation}
t_{\symup{dyn}}=\frac{R}{V}\approx\sqrt\frac{R^{3}}{\symup{G}M}\approx\qty{27}{min}\left(\frac{R}{\unit{R_{\odot}}}\right)^{\frac{3}{2}}\left(\frac{M}{\unit{M_{\odot}}}\right)^{-\frac{1}{2}}.
\end{equation}
...
现在考虑一个小扰动
\begin{equation}
\frac{P_{0}+P_{1}}{P_{0}}=\left(\frac{\rho_{0}+\rho_{1}}{\rho_{0}}\right)^{\gamma}, P_{1}=\symup{c}_{\symup{s}}^{2}\rho_{1},
\end{equation}
连续性方程变为
\begin{equation}
...
解得
\begin{align}
&\rho_{0}\frac{\partial\symbf{v}_{1}}{\partial t}=-\symup{c}_{\symup{s}}^{2}\nabla\rho_{1}-\rho_{0}\nabla\Phi_{1}.\\
&\left(\frac{\partial{}^{2}}{\partial{}t^{2}}-\symup{c}_{\symup{s}}^{2}\nabla^{2}-4\pi\symup{G}\rho_{0}\right)\rho_{1}=0.
\end{align}
上式中，如果引力可被忽略，就是声波方程。如果压力可被忽略，$\rho_{1}\propto\exp\left[\sqrt{4\pi\symup{G}\rho_{0}}t\right]$. 通过三维傅立叶变换可以看出波数和密度分布。引入流体静力学色散关系：
\begin{equation}
\omega^{2}=k^{2}\symup{c}_{\symup{s}}^{2}-4\pi\symup{G}\rho_{0},
\end{equation}
要让波发生演化而不是形成驻波，要求 $\omega$ 是复数。于是我们引入金斯波长
\begin{equation}
\lambda_{\symup{J}}=\frac{h}{p_{\symup{J}}}=\frac{2\pi}{k_{\symup{J}}}=\sqrt{\frac{\pi \symup{c}_{\symup{s}}^{2}}{\symup{G}\rho_{0}}},
\end{equation}
同时有金斯质量：
\begin{equation}
M_{\symup{J}}=\frac{4\pi}{3}\rho\left(\frac{\lambda_{\symup{J}}}{2}\right)^{3}\sim 2M_{\odot}\cdot\left(\frac{\symup{c}_{\symup{s}}}{\qty{0.2}{km\cdot{}s^{-1}}}\right)^{3}\left(\frac{n}{\qty{e3}{cm^{-3}}}\right)^{-\frac{1}{2}}.
\end{equation}
质量大于这个值的分子云才能坍缩。
...
\begin{equation}
\frac{\partial{}^{2}\Delta_{k}}{\partial{}t^{2}}=\left(2\pi\symup{G}\Sigma_{0}k-\Omega^{2}-k^{2}\symup{c}_{\symup{s}}^{2}\right)\Delta_{k}.
\end{equation}
Toomre Q parameter
\begin{equation}
Q=\frac{\symup{c}_{\symup{s}}\Omega}{\pi\symup{G}\Sigma}<1
\end{equation}
时才会坍缩。
...
\begin{equation}
E_{\symup{bind}}=\frac{1}{4\pi\varepsilon_{0}}\frac{{\color{blue}{\ce{e}}}^{2}}{\alpha_{0}}=\alpha^{2}m_{0}\symup{c}^{2}.
\end{equation}
想象有一大堆聚集在一起的气体，其引力势能为
\begin{equation}
E_{\symup{gravity}}\sim\frac{\symup{G}M^{2}}{R}\sim\frac{\symup{G}N^{2}m_{\ce{p}}^{2}}{R}, R\sim N^{\frac{1}{3}}\alpha_{0},
\end{equation}
分子间的结合能为
\begin{equation}
...
M_{\symup{c}}=Nm_{\ce{p}}\sim\qty{e30}{g}.
\end{align}
$M<M_{\symup{c}}$, 则结合能胜利，成为固态行星，否则分子间电磁力无法抗衡引力，云团将以等离子体形式存在。
...
\begin{equation}
U_{\symup{g}}=\frac{\symup{G}M^{2}}{R}\sim U_{\symup{k}}=Nk_{\symup{B}}T,
\end{equation}
记粒子间的距离为 $d, d=R\times N^{-\frac{1}{3}}$, 因此
\begin{equation}
T_{\symup{vir}}\sim N^{\frac{2}{3}}\frac{\symup{G}m_{\ce{p}}^{2}}{d},
\end{equation}
但值得注意的是，当质量足够高时，简并效应开始发挥作用，因此上式需要添加修正项，转为
\begin{equation}
T\sim N^{\frac{2}{3}}\frac{\symup{G}m_{\ce{p}^{2}}}{d}-\frac{1}{m_{0}d^{2}},
\end{equation}
对给定粒子数，$d$ 取 $2N^{-\frac{2}{3}}\left(m_{0}\alpha_{\symup{G}}\right)^{-1}$ 时 $T$ 有最大值，其中 $\alpha_{\symup{G}}=\dfrac{\symup{G}m_{\ce{p}}^{2}}{\hbar\symup{c}}$:
\begin{equation}
T=N^{\frac{4}{3}}\alpha_{\symup{G}}^{2}m_{0}.
\end{equation}
而进行热核反应所需的温度为
\begin{equation}
T_{\symup{nuc}}=\eta\alpha^{2}m_{\ce{p}},
\end{equation}
可以得到临界粒子数密度为
\begin{equation}
N=\eta^{\frac{3}{4}}\left(\dfrac{m_{\ce{p}}}{m_{0}}\right)^{\frac{3}{4}}\left(\frac{\alpha}{\alpha_{\symup{G}}}\right)^{\frac{3}{2}},
\end{equation}
假定 $\eta=0.1$, 临界质量为
\begin{equation}
...
branch, RGB) & 壳层氢燃烧产能率上升，半径上升，& 攀升成为红巨星\\
 & 温度下降，恒星对流区增大 & \\
\cline{1-3}
氦闪 & $T_{\symup{c}}$ 达到 $\qty{e8}{K}$ 时氦开始燃烧，& 攀升到红巨星支的顶点\\
...
(HB) & & \\
\cline{1-3}
渐近巨星支 & 氦核燃烧殆尽，留下 $\symup{CO}$ 核，$R_{\symup{c}}\downarrow, T_{\symup{c}}\uparrow$ & 再次向右上方攀升\\
...
\symbf{\Phi}&=-\frac{1}{1+q}\frac{\symup{G}M_{\symup{total}}}{\left\vert\symbf{r}-\left(-\dfrac{q}{1+q}a, 0, 0\right)\right\vert{}}-\frac{q}{1+q}\frac{\symup{G}M_{\symup{total}}}{\left\vert\symbf{r}-\left(\dfrac{1}{1+q}a, 0, 0\right)\right\vert{}}-\frac{1}{2}\frac{\symup{G}M_{\symup{total}}}{a^{3}}r^{2}.
\end{align}
...
随着费米动量越来越高，$E_{F}=\sqrt{p_{\symup{F}}^{2}\symup{c}^{2}+m_{{\color{blue}{\ce{e}}}}^{2}\symup{c}^{4}}>\left(m_{\ce{n}}-m_{\ce{p}}-m_{{\color{blue}{\ce{e}}}}\right)\symup{c}^{2}$, 从而生成中子。临界动量和密度为
\begin{align}
p_{\symup{F}}&=m_{{\color{blue}{\ce{e}}}}\symup{c}\left[\left(\frac{m_{\ce{n}}-m_{\ce{p}}}{m_{{\color{blue}{\ce{e}}}}}\right)^{2}-1\right]^{\frac{1}{2}}.\\
\rho&\sim\qty{1.2e10}{kg\cdot m^{-3}}.
\end{align}
等密度达到 $\qty{e18}{kg\cdot m^{-3}}$ 的量级，最终产生半径 $\qty{10}{km}$ 的中子星。中子星的特征质量为 $\qty{1.4}{M_{\odot}}$.

中子星质量估计：考虑质子德布罗意波长和普朗克质量 $m_{\symup{planck}}=\sqrt{\dfrac{\hbar\symup{c}}{\symup{G}}}$, 估计得到半径上限 $R_{\max}\sim\dfrac{m_{\symup{planck}}}{m_{\ce{p}}}\times\lambda_{n}\sim\qty{10}{km}$, 粒子数上限 $N\sim\left(\dfrac{m_{\symup{planck}}}{m_{\ce{p}}}\right)^{3}\sim2.2\times10^{57}$, 质量上限 $M_{\max}\sim Nm_{\ce{p}}\sim M_{\odot}$, 密度上限 $\rho_{\max}\sim\dfrac{m_{\ce{p}}}{\lambda_{n}}\sim\qty{e18}{kg\cdot m^{-3}}$.
...
\begin{equation}
U_{\symup{g}}\sim\frac{\symup{G}M^{2}}{R}=2.7\times10^{53}\,\unit{erg}\left(\frac{M}{\unit{M_{\odot}}}\right)^{2}\left(\frac{R}{\qty{10}{km}}\right)^{-1},
\end{equation}
然后是转动动能
\begin{align}
U_{\symup{rot}}&\sim M\Omega^{2}R^{2}\sim7.9\times10^{52}\,\unit{erg}\left(\frac{M}{\unit{M_{\odot}}}\right)\left(\frac{R}{\qty{10}{km}}\right)^{2}\left(\frac{\nu}{\qty{1000}{Hz}}\right)^{2}.\\
\frac{U_{\symup{rot}}}{U_{\symup{g}}}&=0.3\left(\frac{M}{\unit{M_{\odot}}}\right)^{-1}\left(\frac{R}{\qty{10}{km}}\right)^{3}\left(\frac{\nu}{\qty{1000}{Hz}}\right)^{2}.
\end{align}
接着是磁能
\begin{align}
B&\sim1.8\times10^{18}\,\unit{G}\left(\frac{M}{\qty{1.4}{M_{\odot}}}\right)\left(\frac{R}{\qty{10}{km}}\right)^{-2},\\
U_{\symup{B}}&=\frac{4}{3}\pi{}R^{3}\frac{B^{2}}{8\pi},\notag\\
\frac{U_{\symup{B}}}{U_{\symup{g}}}&\sim3\times10^{-13}\left(\frac{M}{\qty{1.4}{M_{\odot}}}\right)^{-2}\left(\frac{R}{\qty{10}{km}}\right)^{4}\left(\frac{B}{\qty{e12}{G}}\right)^{2}.
\end{align}

与通常恒星相比中子星的温度很高，但相对于中子星物质的高密度而言，它可以非常好地用零温近似描述，因此费米能为
\begin{align}
\varepsilon_{\symup{Feimi}}&=\frac{P_{\symup{F}}^{2}}{2m_{\ce{n}}}=\frac{h^{2}}{2m_{\ce{n}}}\left(\frac{3n}{8\pi}\right)^{\frac{2}{3}}=\qty{30}{MeV}\left(\frac{\rho}{\qty{e14}{g\cdot cm^{-3}}}\right)^{\frac{2}{3}}\gg k_{\symup{B}}T.\\
E_{\symup{F}}&=\qty{1.64e53}{erg}\left(\frac{M}{\unit{M_{\odot}}}\right)^{\frac{5}{3}}\left(\frac{R}{\qty{10}{km}}\right)^{-2}.
\end{align}
...
视界：半径为史瓦西半径 $R_{\symup{s}}$ 的球面，在视界内的任何信息都无法向外传递

光层：半径为 $1.5R_{\symup{s}}$ 的球面，在光层各向同性辐射光子中的一半可以逃逸

\subsubsection{Kerr}
对角动量为 $J$ 的黑洞，记 $m=\dfrac{\symup{G}M}{\symup{c}^{2}}, a=\dfrac{J}{M\symup{c}}$, 视界半径为
\begin{equation}
r_{\symup{h}}=\left(\frac{R_{\symup{s}}}{2}\right)\left[m+\sqrt{m^{2}-a^{2}}\right].
\end{equation}
能层为
\begin{equation}
r_{\symup{st}}=\left(\frac{R_{\symup{s}}}2\right)\left[m+\sqrt{m^{2}-a^{2}\cos^{2}{\theta}}\right].
\end{equation}
能层：介于 $r_{\symup{h}}$ 和 $r_{\symup{st}}$ 之间的区域。
...
根据黑洞能损率推测黑洞寿命
\begin{equation}
t=\frac{E}{L}=\frac{M\symup{c}^{2}}{4\pi R_{\symup{s}}^{2}\sigma T^{4}}\propto{}M^{3}
\end{equation}
...
假设行星是黑体，能量全部来自太阳，得到
\begin{align}
&\frac{L_{\odot}}{4\pi R^{2}_{\odot\to\symup{planet}}}\pi R_{\symup{planet}}^{2}\times\left(1-a\right)=4\pi R_{\symup{planet}}^{2}\sigma_{\symup{SB}}T_{\symup{planet}}^{4}.\\
&T_{\symup{eq}}=\left(1-a\right)^{\frac{1}{4}}\sqrt{\frac{R_{\odot}}{2R_{\odot\to\symup{planet}}}}T_{\odot}.
\end{align}
可借此估计行星温度，其中 $a$ 是反照率。

如果大气对短波长的太阳光透明但对长波长的热辐射不透明，会发生什么？恒星入射 $P_{\symup{s}}$ 等于大气向外辐射 $P_{2}$. 对地球表面，大气也向地面辐射 $P_{2}$, 因此 $P_{\symup{s}}+P_{2}=P_{\text{surface}}$. 大气只吸收地面辐射，因此 $2P_{2}=P_{\text{surface}}$. 联立这些式子得到地面温度为
\begin{equation}
T_{\text{surface}}=2^{-\frac{1}{4}}T_{\symup{s}}.
\end{equation}
温室效应恐怖如斯。
...
M_{\symup{p}}\ll M_{1}, M_{\symup{p}}=v_{1}M_{1}^{\frac{2}{3}}\left(\frac{T}{2\pi\symup{G}}\right)^{\frac{1}{3}}.
\end{align}

还要考虑倾角
\begin{equation}
M_{\symup{p}}\sin{i}=v_{1,\symup{obs}}M_{1}^{\frac{2}{3}}\left(\frac{T}{2\pi\symup{G}}\right)^{\frac{1}{3}}.
\end{equation}
轨道倾角 $i$ 并非随机分布。考虑立体角积分方式，实际上是正弦分布。

此外还要考虑选择效应：
\begin{equation}
v_{1,\symup{obs}}=\symup{G}^{\frac{1}{2}}M_{1}^{-\frac{1}{2}}M_{\symup{p}}r_{\symup{p}}^{-\frac{1}{2}}\sin{i}.
\end{equation}
...
\begin{equation}
\alpha=\frac{4\symup{G}M}{\symup{c}^{2}b}=\frac{2R_{\symup{s}}}{b}.
\end{equation}
记源到透镜距离为 $D_{\symup{sl}}$, 透镜到观测者距离为 $D_{\symup{lo}}$, 入射距离对观测者张角为 $\theta_{\symup{E}}$, 像到源的距离为 $D_{\symup{is}}$, 都是小量，于是有
\begin{align}
D_{\symup{is}}&=D_{\symup{so}}\theta_{\symup{E}}=D_{\symup{sl}}\alpha.\\
\theta_{\symup{E}}&=\left(\frac{4\symup{G}M}{\symup{c}^{2}}\frac{D_{\symup{sl}}}{D_{\symup{lo}}D_{\symup{so}}}\right)^{\frac{1}{2}}.
\end{align}

如果源、透镜、观测者并非三点一线，透镜和源相对观测者有夹角 $\beta$, 简单的几何关系告诉我们，像和透镜的夹角满足
\begin{equation}
\theta^{2}-\beta\theta-\theta_{\symup{E}}^{2}=0.
\end{equation}

透镜会放大相，放大率满足
\begin{align}
a_{\pm}=\frac{\theta_{\pm}}{\beta}\frac{\d\theta_{\pm}}{\d\beta}=\frac{\theta_{\pm}}{\beta}\left[1\pm\frac{\beta}{\left(\beta^{2}+4\theta_{\symup{E}}^{2}\right)^{\frac{1}{2}}}\right].\\
a_{\symup{total}}=a_{+}+a_{-}=\frac{u^{2}+2}{u\left(u^{2}+4\right)^{\frac{1}{2}}}, u=\frac{\beta}{\theta_{\symup{E}}}.
\end{align}

对于系外源我们忽视 $\beta$ 的变化，我们会考虑恒星穿越透镜区域
\begin{equation}
\beta\left(t\right)=\left[\beta_{0}^{2}+\frac{v^{2}}{D_{\symup{lo}}^{2}}\left(t-t_{0}\right)^{2}\right]^{\frac{1}{2}}.
\end{equation}
因此会产生光变曲线。光变时标
\begin{equation}
\tau=\frac{\theta_{\symup{E}}D_{\symup{lo}}}{v}.
\end{equation}

如果透镜附近有个小行星，行星的透镜会让光变曲线会变成一大一小的叠加。其他参数是一致的，那么光变曲线的时标比会给出质量比
\begin{equation}
\frac{\tau_{\symup{p}}}{\tau_{\symup{star}}}=\frac{\theta_{\symup{p}}}{\theta_{\symup{star}}}=\left(\frac{M_{\symup{p}}}{M_{\symup{star}}}\right)^{\frac{1}{2}}.
\end{equation}
...
潮汐力会引起天体解体
\begin{equation}
\frac{2\symup{G}M_{\symup{p}}R_{\symup{m}}}{r^{3}}>\frac{\symup{G}M_{\symup{m}}}{R_{\symup{m}}^{2}}, r<2^{\frac{1}{3}}\left(\frac{M_{\symup{p}}}{M_{\symup{m}}}\right)^{\frac{1}{3}}R_{\symup{m}}.
\end{equation}
其中 $R_{\symup{m}}$ 是卫星半径。
