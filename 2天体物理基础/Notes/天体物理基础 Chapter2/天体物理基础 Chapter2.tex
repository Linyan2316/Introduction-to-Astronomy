...
首先 Maxwell 速度分布为
\begin{align}
f\left(v\right)\symup{d}v&=\left(\frac{m}{2\pi k_{\symup{B}}T}\right)^{\frac{3}{2}}\exp\left(-\frac{mv^{2}}{2k_{\symup{B}}T}\right)4\pi v^{2}\symup{d}v,\\
f\left(E\right)\symup{d}E&=\frac{2}{\sqrt{\pi}}\frac{E^{\frac{1}{2}}}{\left(k_{\symup{B}}T\right)^{\frac{3}{2}}\exp\left(-\dfrac{E}{k_{\symup{B}}T}\right)}\symup{d}E.
\end{align}
...
&=n_{1}n_{2}\frac{2^{\frac{3}{2}}}{\left(\pi m\right)^{\frac{1}{2}}}\frac{1}{\left(k_{\symup{B}}T\right)^{\frac{3}{2}}}\int_{0}^{\infty}S\left(E\right)\exp\left(-\frac{E_{\text{G}}^{\frac{1}{2}}}{E^{\frac{1}{2}}}\right)\exp\left(-\frac{E}{k_{\symup{B}}T}\right)\symup{d}E.
\end{align}
...
\begin{equation}
\frac{\symup{d}T}{\symup{d}r}=\left.\frac{\symup{d}T}{\symup{d}r}\right\vert_{\text{rad}}+\left.\frac{\symup{d}T}{\symup{d}r}\right\vert_{\text{conv}}.
\end{equation}
...
\left.\frac{\symup{d}T}{\symup{d}r}\right\vert_{\text{ad}}&=\left(1-\frac{1}{\gamma}\right)\frac{T}{P}\frac{\symup{d}P}{\symup{d}r}=-\left(1-\frac{1}{\gamma}\right)\frac{\mu m_{\ce{H}}}{k_{\symup{B}}}\frac{\symup{G}M_{r}}{r^{2}}.
\end{align}
我们认为 $\left\vert{}\dfrac{\symup{d}T}{\symup{d}r}\right\vert_{\text{actual}}<\left\vert{}\dfrac{\symup{d}T}{\symup{d}r}\right\vert_{\text{ad}}$ 的是辐射区，反之是对流区。
