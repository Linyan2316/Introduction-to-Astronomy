...
\begin{equation}
\d{}M_{r}=4\pi r^{2}\rho\mleft(r\mright)\d{}r
\end{equation}
和流体静力学方程
\begin{equation}
\frac{\d{}P}{\d{}r}=-\frac{\symup{G}M_{r}\rho\mleft(r\mright)}{r^{2}}\label{2.1.2}
\end{equation}
就不赘述了。
...
\begin{align}
\d{}U_{\mathrm{g}, i}&=-\symup{G}\frac{M_{r}\d{}m_{i}}{r},\notag\\
U_{\mathrm{g}}&=-\symup{G}\int_{0}^{R}\frac{4}{3}\pi r^{3}\rho\frac{4\pi r^{2}\rho\d{}r}{r}\notag\\
&=-\symup{G}\int_{0}^{R}\frac{16}{3}\pi^{2}r^{4}\rho^{2}\d{}r=-\frac{16}{15}\pi^{2}\symup{G}\rho^{2}R^{5}=-\frac{3}{5}\frac{\symup{G}M^{2}}{R}.
\end{align}
...
\begin{align}
\frac{1}{2}m_{\ce{H}}v^{2}&=\frac{3}{2}\symup{k}_{\mathrm{B}}T_{\mathrm{classical}}=\frac{1}{4\pi\varepsilon_{0}}\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}}{r},\\
T_{\mathrm{classical}}&=\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}}{6\pi\varepsilon_{0}\symup{k}_{\mathrm{B}}r}\sim\qty{e10}{K}.
\end{align}
对于恒星来讲这个温度实在是难以达到。好在量子图景下，即使核子动能不足以跨越库仑势垒，它也有一定的概率穿越它。此时所需的温度为
\begin{align}
\frac{1}{4\pi\varepsilon_{0}}\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}}{\lambda}&=\frac{p^{2}}{2m_{\ce{H}}}=\frac{\mleft(h/\lambda\mright)^{2}}{2m_{\ce{H}}},\\
\lambda&=\frac{2\pi\varepsilon_{0}h^{2}}{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}m_{\ce{H}}}\to r,\\
T_{\mathrm{quantum}}&=\frac{Z_{1}^{2}Z_{2}^{2}{\color{blue}{\ce{e}}}^{4}m_{\ce{H}}}{12\pi^{2}\varepsilon_{0}^{2}\symup{k}_{\mathrm{B}}h^{2}}\sim\qty{e7}{K}.
\end{align}
这个温度就比较容易达到了。我们可以来估计一下太阳内部的压力和温度。根据 (\ref{2.1.2}) 式可知，
\begin{equation}
P=\int_{0}^{P}\d{}P=\int_{R}^{0}-\frac{\symup{G}M_{r}\rho}{r^{2}}\d{}r=\int_{R}^{0}-\frac{\symup{G}4\pi{}r^{3}\rho^{2}}{3r^{2}}\d{}r=\frac{2\pi{}}{3}\rho^{2}\symup{G}R^{2},\overline{P}\sim\qty{e14}{Pa},
\end{equation}
因此太阳平均温度可达 $T=\dfrac{\mu m_{\ce{H}}\overline{P}}{\symup{k}_{\mathrm{B}}\rho}\sim\qty{5e6}{K}$, 核心温度可达 $\qty{1.5e7}{K}$, 因此仅凭借云团坍缩过程中所释放的引力能就足以达到支持热核反应所需要的高温。
...
首先 Maxwell 速度分布为
\begin{align}
f\mleft(v\mright)\d{}v&=\mleft(\frac{m}{2\pi\symup{k}_{\mathrm{B}}T}\mright)^{\frac{3}{2}}\exp\mleft(-\frac{mv^{2}}{2\symup{k}_{\mathrm{B}}T}\mright) 4\pi v^{2}\d{}v,\\
f\mleft(E\mright)\d{}E&=\frac{2}{\sqrt{\pi}}\frac{E^{\frac{1}{2}}}{\mleft(\symup{k}_{\mathrm{B}}T\mright)^{\frac{3}{2}}\exp\mleft(-\dfrac{E}{\symup{k}_{\mathrm{B}}T}\mright)}\d{}E.
\end{align}
其中 $m$ 是两粒子的约化质量 $\dfrac{m_{1}m_{2}}{m_{1}+m_{2}}$. 其次量子隧穿的概率为
\begin{equation}
P\propto\exp\mleft[-\frac{1}{2\varepsilon_{0}\hbar}\mleft(\frac{m}{2}\mright)^{\frac{1}{2}}\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}}{\sqrt{E}}\mright],
\end{equation}
直接用概率算有点麻烦，转而用反应截面描述。反应截面与能量大致呈反比，而库仑势的影响一般可用 Gamow Energy 表示，最后加一项与纯粹核物理过程有关、随能量变化不剧烈的函数 $S\mleft(E\mright)$:
\begin{align}
\sigma\mleft(E\mright)&=\frac{S\mleft(E\mright)}{E}\exp\mleft[-\frac{E_{\mathrm{G}}^{\frac{1}{2}}}{E^{\frac{1}{2}}}\mright],\\
E_{\mathrm{G}}&=\mleft[\frac{1}{2\varepsilon_{0}\hbar}\mleft(\frac{m}{2}\mright)^{\frac{1}{2}}Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}\mright]^{2},
\end{align}
结合 Maxwell 速度分布就能得到反应速率：
\begin{align}
r&=n_{1}n_{2}\int_{0}^{\infty}\sigma\mleft(E\mright) vf\mleft(E\mright)\d{}E\notag\\
&=n_{1}n_{2}\frac{2^{\frac{3}{2}}}{\mleft(\pi m\mright)^{\frac{1}{2}}}\frac{1}{\mleft(\symup{k}_{\mathrm{B}}T\mright)^{\frac{3}{2}}}\int_{0}^{\infty}S\mleft(E\mright)\exp\mleft(-\frac{E_{\mathrm{G}}^{\frac{1}{2}}}{E^{\frac{1}{2}}}\mright)\exp\mleft(-\frac{E}{\symup{k}_{\mathrm{B}}T}\mright)\d{}E.
\end{align}
观察上式可知在某个能量处反应速率最大，也就是 Gamow Peak:
\begin{equation}
E_{0}=\mleft[\mleft(\frac{m}{2}\mright)^{\frac{1}{2}}\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}\symup{k}_{\mathrm{B}}T}{4\varepsilon_{0}\hbar}\mright]^{\frac{2}{3}}=\mleft(\frac{E_{\mathrm{G}}^{\frac{1}{2}}\symup{k}_{\mathrm{B}}T}{2}\mright)^{\frac{2}{3}}.
\end{equation}
看表达式可知 $E_{0}$ 是热能 $\symup{k}_{\mathrm{B}}T$ 和 $E_{\mathrm{G}}$ 按照 $2: 1$ 的几何平均。

接着计算能量产生效率，首先一次反应释放的能量为
\begin{equation}
\laplacian\varepsilon=\mleft(A_{1}+A_{2}\mright) f\mleft(A_{12}\mright)-A_{1}f\mleft(A_{1}\mright)-A_{2}f\mleft(A_{2}\mright)+E_{0}.
\end{equation}
将 $S\mleft(E_{0}\mright)$ 从反应速率表达式的积分中提出来，得到
\begin{equation}
r\propto{}n_{1}n_{2}\frac{S\mleft(E_{0}\mright)}{T^{\frac{2}{3}}}\exp\mleft[-3\mleft(\frac{{\color{blue}{\ce{e}}}^{4}}{32\varepsilon_{0}^{2}\symup{k}_{\mathrm{B}}\hbar^{2}}\frac{mZ_{1}^{2}Z_{2}^{2}}{T}\mright)^{\frac{1}{3}}\mright].
\end{equation}

于是我们可以定义聚变效率 $C$, 一般用实验而不是计算确定。最后可借此得到单位体积的能量产生率 $\varepsilon$
\begin{align}
r\laplacian\varepsilon&=\rho\varepsilon.\\
&\varepsilon=C\rho X_{1}X_{2}\frac{1}{T^{\frac{2}{3}}}\exp\mleft[-3\mleft(\frac{{\color{blue}{\ce{e}}}^{4}}{32\varepsilon_{0}^{2}\symup{k}_{\mathrm{B}}\hbar^{2}}\frac{mZ_{1}^{2}Z_{2}^{2}}{T}\mright)^{\frac{1}{3}}\mright].
\end{align}

\subsubsection{恒星中的聚变过程}
氢核聚变是最为常见的热核反应，其核反应方程式为
\begin{equation}
\ce{4{}^{1}H ->{}^{4}He +2{\color{blue}{\ce{e}}}^{+}}+2\nu_{{\color{blue}{\ce{e}}}}+\mathrm{energy}.
\end{equation}
其中 $\nu_{{\color{blue}{\ce{e}}}}$ 是电子中微子。此过程中释放的能量为 $E=\mleft(4m_{\ce{H}}-m_{\ce{He}}\mright)\symup{c}^{2}=\qty{4e-5}{erg}$, 燃烧效率为 $0.7\%$, 即以质量计有 $0.7\%$ 的初始燃料完全转化为能量。
...
\ce{^{13}N &->^{13}C +e+}+\nu_{\ce{e}},\enspace\text{$\beta$-decay $\tau_{\frac{1}{2}}\sim\qty{10}{min}$},\\
\ce{^{13}C +^{1}H &->^{14}N}+\gamma,\\
\ce{^{14}N +^{1}H &->^{15}O}+\gamma,\\
\ce{^{15}O &->^{15}N +e+}+\nu_{\ce{e}},\enspace\text{$\beta$-decay $\tau_{\frac{1}{2}}\sim\qty{2}{min}$},\\
...
\end{align*}
$\ce{^{4}He}$ 与 $\ce{^{12}C}$ 之间没有稳定的原子核。两个氦核反应生成 $\ce{^{8}Be}$ 需要吸能 $\qty{91.8}{keV}$, 在 $T\sim1\text{\textendash}\qty{2e8}{K}$ 时需要 Gamow Peak $\sim\qty{100}{keV}$. $\ce{^{8}Be}$ 很不稳定，好在生成率足够高可以达到统计平衡，使其有机会再与氦核碰撞生成高能碳原子。发生此反应时，相同温度下需要 Gamow Peak 达到原来的 2.5 倍。此时该高能碳原子比初始氦原子的能级高 $\qty{350}{keV}$, 或者说它比基态 $\ce{^{12}C}$ 高了 $\mleft(7.25+0.35\mright)\,\unit{MeV}$, 能级差主要来自于前面吸收的结合能。由于碳原子有一个 $\qty{7.65}{MeV}$ 的能级，二者很接近，因此生成的碳原子可以快速退激发，加速反应正向进行。此反应是恒星中碳的重要来源。

生成的碳原子还可以与氦原子结合产生氧，但是氧缺乏这种能与结合能动能之和对应起来的能级，因此反应没有那么迅速。这告诉我们 $S\mleft(E\mright)$ 与碰撞能量、结合能、产物能级有密切的关系。
...
\hline
Stage & Products & Duration & $T\mleft(\qty{e9}{K}\mright)$ & $\rho\mleft(\unit{kg\cdot m^{-3}}\mright)$ & Mass\\
\cline{1-6}
...
我们将 (\ref{2.1.2}) 式两侧同乘 $4\pi r^{3}\d{}r$ 并积分：
\begin{equation}
\int_{0}^{R}\frac{\d{}P}{\d{}r}4\pi{}r^{3}\d{}r=\int_{0}^{R}\mleft(-\frac{\symup{G}M_{r}}{r^{2}}\rho\mright) 4\pi{}r^{3}\d{}r,
\end{equation}
利用分部积分得到
\begin{equation}
-\int_{0}^{R}3P4\pi{}r^{2}\d{}r=\int_{0}^{R}\mleft(-\frac{\symup{G}M_{r}}{r}\mright) 4\pi{}r^{2}\rho\d{}r.
\end{equation}
对于理想气体而言，气压 $P=n\symup{k}_{\mathrm{B}}T$, 内能 $E_{\mathrm{T}}=\dfrac{3}{2}n\symup{k}_{\mathrm{B}}T$, 因此 $3P=2E_{\mathrm{T}}$, 上式积分左侧结果为 $-2U_{\mathrm{T}}$, 而右侧正是引力能 $U_{\mathrm{g}}$, 因此恒星总能量为 $U_{\mathrm{total}}=U_{\mathrm{T}}+U_{\mathrm{g}}=\dfrac{1}{2}U_{\mathrm{g}}=-U_{\mathrm{T}}$, 恒星温度升高，动能上高，总能量反而下降，因此恒星是个负热容系统。

而对相对论物质来说，因为 $E_{\mathrm{T}}=3P$, 因此 $U_{\mathrm{T}}=-U_{\mathrm{g}}$, 因此总能量为 $0$.

\subsubsection{恒星的压力来源}
恒星内部的压力来源主要有三种：气体运动产生的气压 $P_{\mathrm{g}}$, 光子辐射压 $P_{\mathrm{rad}}$ 以及粒子简并压。

首先考虑非简并气体。我们在介绍质光关系的时候就计算过它们的辐射压：
\begin{equation}
P_{\mathrm{rad}}=\frac{1}{3}a_{\mathrm{B}}T^{4}.
\end{equation}
而对于气压，我们假设非简并气体状态方程为理想气体状态方程
\begin{equation}
P_{\mathrm{g}}=n\symup{k}_{\mathrm{B}}T,
\end{equation}
其中 $n$ 是粒子数密度。记气体一共包含 $n'$ 摩尔的分子，那么
\begin{equation}
n=\frac{n'N_{\mathrm{A}}}{V}=\frac{n'N_{\mathrm{A}}}{\dfrac{m}{\rho}}=\frac{\rho}{\dfrac{m}{n'N_{\mathrm{A}}}}=\frac{\rho}{\mu m_{\ce{H}}},
\end{equation}
其中 $N_{\mathrm{A}}$ 是阿伏伽德罗常数，$\mu$ 为平均相对分子质量，$m_{\ce{H}}$ 是质子的实际质量，数值上等于 $\dfrac{1}{N_{\mathrm{A}}}$. 故非简并理想气体的气压可以写作
\begin{equation}
P_{\mathrm{g}}=\frac{\rho\symup{k}_{\mathrm{B}}T}{\mu m_{\ce{H}}}.
\end{equation}
...
\begin{equation}
P_{\mathrm{g}}=n_{{\color{blue}{\ce{e}}}}\symup{k}_{\mathrm{B}}T+\sum_{i}n_{i}\symup{k}_{\mathrm{B}}T=\sum_{i}\mleft(Z_{i}+1\mright) n_{i}\symup{k}_{\mathrm{B}}T=\sum_{i}\mleft(1+Z_{i}\mright)\frac{\rho\chi_{i}\symup{k}_{\mathrm{B}}T}{A_{i}m_{\ce{H}}}=\frac{\rho\symup{k}_{\mathrm{B}}T}{\mu m_{\ce{H}}}.
\end{equation}
因此相对分子量为
\begin{equation}
\frac{1}{\mu}=\sum_{i}\mleft(1+Z_{i}\mright)\frac{\chi_{i}}{A_{i}}.
\end{equation}
习惯上记 $\ce{H},\ce{He}$ 和金属元素的质量百分比为 $X, Y, Z$, 且认为金属元素质子数与中子数相当，即 $\dfrac{Z_{i}}{A_{i}}=\dfrac{1}{2}$, 那么对于考虑电子气体的情况，
\begin{equation}
P_{\mathrm{g}}=\rho\symup{k}_{\mathrm{B}}T\frac{2X+\dfrac{3}{4}Y+\dfrac{1}{2}Z}{m_{\ce{H}}}.
\end{equation}

有时候我们不考虑电子气体的贡献，即只有一大堆离子，那么
\begin{align}
\frac{1}{\mu}&=\sum_{i}\frac{\chi_{i}}{A_{i}}\\
P_{\mathrm{g}}&=\rho\symup{k}_{\mathrm{B}}T\frac{X+\dfrac{1}{4}Y}{m_{\ce{H}}}.
\end{align}
同时我们还能给出电子气体的相对分子质量来表征其贡献
\begin{equation}
\mu_{{\color{blue}{\ce{e}}}}^{-1}=\sum_{i}\frac{Z_{i}\chi_{i}}{A_{i}}\approx X+\frac{1}{2}\mleft(1-X\mright)=\frac{1+X}{2}.
\end{equation}
...
首先一般气体的压强及其在动量空间的分布 $f\mleft(p\mright)$ 满足如下关系
\begin{equation}
P=\frac{1}{3}\int vpf\mleft(p\mright) 4\pi p^{2}\d{}p.\label{2.1.37}
\end{equation}
一般理想气体的分布满足麦克斯韦分布，因此压强满足
\begin{equation}
P=n\symup{k}_{\mathrm{B}}T.
\end{equation}
而密度足够高的情况下，泡利不相容原则迫使粒子占据更高的动量态，因此
\begin{equation}
f\mleft(p\mright)=\frac{2}{h^{3}}.
\end{equation}
2 源自自旋，$h^{3}$ 源自归一。因此单位动量对应的单位粒子数为
\begin{equation}
\d{}n=\frac{2V}{h^{3}}4\pi p^{2}\d{}p.
\end{equation}
假设动量有个最高限制 $p_{\mathrm{F}}$, 积分可以得到电子数密度：
\begin{equation}
n_{{\color{blue}{\ce{e}}}}=\int_{0}^{p_{\mathrm{F}}}\frac{8\pi}{h^{3}}p^{2}\d{}p=\frac{8\pi}{3h^{3}}p_{\mathrm{F}}^{3},
\end{equation}
那么反过来讲，已知电子数密度就知道了动量的最高分布，可借此确定积分限，代入 (\ref{2.1.37}) 式得到
\begin{equation}
P=\frac{1}{3}\int_{0}^{p_{\mathrm{F}}}vp\frac{2}{h^{3}}4\pi p^{2}\d{}p.
\end{equation}
根据狭义相对论，$v=\dfrac{p}{\gamma m}=\dfrac{p\symup{c}^{2}}{\sqrt{p^{2}\symup{c}^{2}+m^{2}\symup{c}^{4}}}$, 于是有
\begin{equation}
P=\frac{8\pi}{3}\int_{0}^{p_{\mathrm{F}}}\frac{p^{4}\symup{c}^{2}}{\sqrt{p^{2}\symup{c}^{2}+m^{2}\symup{c}^{4}}}\d{}p.\label{2.1.46}
\end{equation}

电子数密度又与原子密度相关
\begin{equation}
n_{{\color{blue}{\ce{e}}}}=\frac{\chi_{\rho}}{m_{\ce{H}}}+\frac{\mleft(1-\chi\mright)\rho}{2m_{\ce{H}}}=\frac{\rho}{2m_{\ce{H}}}\mleft(1+\chi\mright)=\frac{\rho}{\mu_{{\color{blue}{\ce{e}}}}m_{\ce{H}}},
\end{equation}
因此费米动量可以表示为
\begin{equation}
p_{\mathrm{F}}=\mleft(\frac{3h^{3}\rho}{8\pi\mu_{{\color{blue}{\ce{e}}}}m_{\ce{H}}}\mright)^{\frac{1}{3}}.
\end{equation}
相对论情况下，(\ref{2.1.46}) 式结果为
\begin{equation}
P=\frac{8\pi}{15h^{3}m_{{\color{blue}{\ce{e}}}}}p_{\mathrm{F}}^{5}=\frac{3^{\frac{2}{3}}}{20\pi^{\frac{2}{3}}}\frac{h^{2}}{m_{{\color{blue}{\ce{e}}}}}n_{{\color{blue}{\ce{e}}}}^{\frac{5}{3}}.
\end{equation}
非相对论情况下，
\begin{equation}
P=\frac{2\pi\symup{c}}{3h^{3}}p_{\mathrm{F}}^{4}=\frac{3^{\frac{1}{3}}}{8\pi^{\frac{1}{3}}}h\symup{c}n_{{\color{blue}{\ce{e}}}}^{\frac{4}{3}}.
\end{equation}
...
我们在第一章中曾提到过，恒星内部不同半径处有不同的黑体谱。接下来我们将说明，能量和压强都依赖于局域黑体谱，能量的传输则依赖黑体谱的梯度。记 $\mu=\cos{\theta}$, 对于任意函数 $A\mleft(\nu\mright)$, 其积分 $\int A\mleft(\mu\mright)\d\Omega$ 结果为 $2\pi\int_{-1}^{1}A\mleft(\mu\mright)\d\mu$, 因此有
\begin{align}
U_{\nu}&=\frac{2\pi}{\symup{c}}\int_{-1}^{1}I_{\nu}\d\mu=\frac{4\pi}{\symup{c}}B_{\nu}\mleft(\tau_{\nu}\mright),\\
F_{\nu}&=2\pi\int_{-1}^{1}I_{\nu}\mu\d\mu=\frac{4\pi}{3}\frac{\d{}B_{\nu}}{\d\tau_{\nu}},\\
P_{\nu}&=\frac{2\pi}{\symup{c}}\int_{-1}^{1}I_{\nu}\mu^{2}\d\mu=\frac{4\pi}{3\symup{c}}B_{\nu}\mleft(\tau_{\nu}\mright).\\
J_{\nu}&=\frac{1}{2}\int_{-1}^{1}I\d\mu=\frac{\symup{c}}{4\pi{}}U_{\nu}.
\end{align}

灰大气意味着吸收系数 $\alpha_{\nu}$ 与频率无关，因此此时光深 $\tau_{\nu}$ 只是高度的函数，辐射转移方程可以写作
\begin{equation}
\mu\frac{\partial{}I\mleft(\tau,\mu\mright)}{\partial\tau}=I-S.\label{2.1.52}
\end{equation}
...
\begin{equation}
\mu\frac{\partial{}I\mleft(\tau,\mu\mright)}{\partial\tau}=I-J.
\end{equation}
(\ref{2.1.52}) 式两侧同乘 $\dfrac{2\pi\mu}{\symup{c}}$ 然后对 $\mu$ 积分，得到
\begin{equation}
\frac{\d{}P}{\d\tau}=\frac{F}{\symup{c}},\label{2.1.57}
\end{equation}
由于 $F$ 是常数，得到
\begin{align}
P&=\frac{F}{\symup{c}}\mleft(\tau+q\mright).\\
S&=J=\frac{\symup{c}}{4\pi}U=\frac{3F}{4\pi}\mleft(\tau+q\mright).
\end{align}
代入辐射转移方程得到
\begin{align}
I\mleft(0,\mu\mright)&=\int_{0}^{\infty}\frac{S}{\mu}\symup{e}^{\mleft(-\frac{t}{\mu}\mright)}\d{}t=\frac{3F}{4\pi}\mleft(\mu+q\mright),\\
F&=2\pi\int_{0}^{1}I\mleft(0,\mu\mright)\mu\d\mu=\frac{3F}{2}\mleft(\frac{1}{3}+\frac{q}{2}\mright).\\
q&=\frac{2}{3}.
\end{align}
再根据斯特藩玻尔兹曼方程得到
\begin{align}
U&=a_{\mathrm{B}}T^{4}, F=\frac{\symup{c}a_{\mathrm{B}}}{4}T_{\mathrm{eff}}^{4},\\
T^{4}&=\frac{3}{4}T_{\mathrm{eff}}^{4}\mleft(\tau+\frac{2}{3}\mright).\\
I\mleft(0,\mu\mright)&=\frac{3F}{4\pi}\mleft(\mu+\frac{2}{3}\mright).
\end{align}
太阳圆面中心处 $\mu=1$, 边缘处 $\mu=0$, 因此太阳圆面边缘处更暗，这被称作临边昏暗。

接下来我们研究能量在恒星内部的传输。首先建立能量守恒方程。记单位时间内通过半径为 $r$ 的球面的能量为 $L\mleft(r\mright)$, 单位物质在单位时间产生的能量（来自核反应和引力势能转换）为 $\varepsilon\mleft(r\mright)$, 那么半径为 $r$, 厚度为 $\d{}r$ 的球壳两侧的能量差为
\begin{equation}
\d{}L_{r}=L\mleft(r+\d{}r\mright)-L\mleft(r\mright)=\varepsilon\d{}M_{r}=4\pi{}r^{2}\rho\varepsilon\d{}r.
\end{equation}
...
\begin{equation}
\frac{\d{}T}{\d{}r}=\mleft.\frac{\d{}T}{\d{}r}\mright\vert_{\mathrm{rad}}+\mleft.\frac{\d{}T}{\d{}r}\mright\vert_{\mathrm{conv}}.
\end{equation}

首先考虑辐射部分。其实我们已经推导过了，在介绍 Eddington 光度时就考虑过辐射压和引力的平衡，在推导质光关系时将其扩展得到
\begin{equation}
\frac{\symup{G}M}{r^{2}}=\frac{1}{\rho}\frac{\d{}P}{\d{}r}=\frac{1}{\symup{c}}\kappa\frac{L}{4\pi r^{2}}=\frac{1}{\rho}\frac{4}{3}a_{\mathrm{B}}T^{3}\frac{\d{}T}{\d{}r},\tag{\ref{1.4.11}}
\end{equation}
稍作整理并修正下正负号便是所需要的方程
\begin{equation}
\frac{\d{}T}{\d{}r}=-\frac{3}{4a_{\mathrm{B}}\symup{c}}\frac{\kappa\rho}{T^{3}}\frac{L_{r}}{4\pi r^{2}}.\label{2.1.68}
\end{equation}
...
\end{equation}
定义 Rosseland Mean $\alpha_{\mathrm{R}}=\dfrac{\int\dfrac{\d{}P_{\nu}}{\d{}z}d\nu}{\int\dfrac{1}{\alpha_{\nu}}\dfrac{\d{}P_{\nu}}{\d{}z}d\nu}$, 得到
\begin{equation}
F=-\frac{\symup{c}}{\alpha_{\mathrm{R}}}\frac{\d{}P}{\d{}z},
\end{equation}
压力和黑体谱也有关联 ($P_{\nu}=\dfrac{4\pi}{3\symup{c}}B_{\nu}\mleft(\tau_{\nu}\mright)$), 所以
\begin{align}
\frac{\d{}P_{\nu}}{\d{}z}&=\frac{4\pi}{3\symup{c}}\frac{\partial{}B_{\nu}}{\partial{}T}\frac{\d{}T}{\d{}z}.\\
\frac{1}{\alpha_{\mathrm{R}}}&=\frac{\int\dfrac{1}{\alpha_{\nu}}\dfrac{\partial{}B_{\nu}}{\partial{}T}\d\nu}{\int\dfrac{\partial{}B_{\nu}}{\partial{}T}\d\nu}.
\end{align}
再考虑到压强和内能和温度的关系，最后得到
\begin{equation}
F=-\frac{\symup{c}}{\alpha_{\mathrm{R}}}\frac{\d{}}{\d{}z}\mleft(\frac{a_{\mathrm{B}}}{3}T^{4}\mright).
\end{equation}
最后由于 $\alpha_{\mathrm{R}}=\rho\kappa, L_{r}=4\pi{}r^{2}F$,
\begin{equation}
\frac{\d{}T}{\d{}r}=-\frac{3}{4a_{\mathrm{B}}\symup{c}}\frac{\rho\kappa}{T^{3}}\frac{L_{r}}{4\pi{}r^{2}}.
\end{equation}
...
可知
\begin{align}
\frac{\d{}P}{\d{}r}&=-\frac{P}{\mu}\frac{\d\mu}{\d{}r}+\frac{P}{\rho}\frac{\d\rho}{\d{}r}+\frac{P}{T}\frac{\d{}T}{\d{}r},\notag\\
\frac{\d{}P}{\d{}r}&=\gamma\frac{P}{\rho}\frac{\d\rho}{\d{}r},\notag\\
\mleft.\frac{\d{}T}{\d{}r}\mright\vert_{\mathrm{ad}}&=\mleft(1-\frac{1}{\gamma}\mright)\frac{T}{P}\frac{\d{}P}{\d{}r}=-\mleft(1-\frac{1}{\gamma}\mright)\frac{\mu m_{\ce{H}}}{\symup{k}_{\mathrm{B}}}\frac{\symup{G}M_{r}}{r^{2}}.
\end{align}
我们认为 $\mleft\vert\dfrac{\d{}T}{\d{}r}\mright\vert_{\mathrm{actual}}<\mleft\vert\dfrac{\d{}T}{\d{}r}\mright\vert_{\mathrm{ad}}$ 的是辐射区，反之是对流区。
...
\subsubsection{多方球模型}
有了上述的方程，我们可以给出恒星的多方球模型 (Polytropic Model). 首先考虑边界条件：$r=0$ 时，$M\mleft(r\mright)=0, L=0$; $r=R$ 时，$M\mleft(r\mright)=M, T\mleft(r\mright)=0, P\mleft(R\mright)=0$. 接着我们假设恒星是球对称结构，各物理量只与半径有关。其次，主序星处于完全流体静力学平衡，压强（来自气压和辐射压）梯度与引力平衡，得到
\begin{align}
\frac{\symup{G}M_{r}\rho\d{}A\d{}r}{r^{2}}&=\mleft(P\mleft(r\mright)-P\mleft(r+\d{}r\mright)\mright)\d{}A=-\d{}P\mleft(r\mright)\d{}A,\\
\frac{\d{}P}{\d{}r}&=-\frac{\symup{G}M_{r}\rho}{r^{2}}.\\
\frac{\d{}}{\d{}r}\mleft(\frac{r^{2}}{\rho}\frac{\d{}P}{\d{}r}\mright)&=-\symup{G}\frac{\d{}M_{r}}{\d{}r}=-\symup{G}\mleft(4\pi r^{2}\rho\mright).\\
\frac{1}{r^{2}}\frac{\d{}}{\d{}r}\mleft(\frac{r^{2}}{\rho}\frac{\d{}P}{\d{}r}\mright)&=-4\pi\symup{G}\rho.
\end{align}
...
如此一来压力引力平衡方程可以改写为
\begin{equation}
\mleft(\frac{n+1}{n}\mright)\frac{K}{r^{2}}\frac{\d{}}{\d{}r}\mleft(r^{2}\rho^{\frac{1}{n}-1}\frac{\d\rho}{\d{}r}\mright)=-4\pi\symup{G}\rho.\label{2.1.33}
\end{equation}
接着作代换
\begin{align}
\rho\mleft(r\mright)&=\rho_{\mathrm{c}}\mleft[\theta_{n}\mleft(r\mright)\mright]^{n},\\
r&=a_{n}\xi\mleft(r\mright),\\
a_{n}&=\mleft[\frac{\mleft(n+1\mright) K}{4\pi\symup{G}}\rho_{\mathrm{c}}^{\frac{1}{n}-1}\mright]^{\frac{1}{2}},\label{2.1.86}
\end{align}
其中 $\rho_{\mathrm{c}}$ 代表恒星中心的密度，如此一来 (\ref{2.1.33}) 式可以改写为 Lane-Emden 方程的形式：
\begin{equation}
\frac{1}{\xi^{2}}\frac{\d{}}{\d\xi}\mleft(\xi^{2}\frac{\d\theta_{n}}{\d\xi}\mright)=-\theta_{n}^{n}.
\end{equation}
上式仅在 $n=0, 1, 5$ 时有解析解：
\begin{align}
\theta_{0}&=1-\frac{\xi^{2}}{6},\\
\theta_{1}&=\frac{\sin{\xi}}{\xi},\\
\theta_{5}&=\mleft[1+\frac{\xi^{2}}{3}\mright]^{-\frac{1}{2}}.
\end{align}
其结果表明恒星从表面到中心密度、温度、压强等物理量是单调上升的。

不过实际情况 $n$ 可能无法取这三个正整数。此时要用到 scaling relation. 对于 $n<5$ 的情况，总存在一个半径 $R=a\xi_{1}$, 在此处 $\rho=0$. 对于相同的 $n$, 无论物体成分如何，其无量纲数 $\xi_{1}$ 总是一致的。根据 (\ref{2.1.86}) 式，对于给定的 $n$, $R\propto\rho_{\mathrm{c}}^{\frac{1-n}{2n}}$. 总质量满足
\begin{equation}
M=\int_{0}^{R}4\pi{}r^{2}\rho\d{}r=4\pi{}a^{3}\rho_{\mathrm{c}}\int_{0}^{\xi_{1}}\xi^{2}\theta^{n}\d\xi,
\end{equation}
因此对于给定的 $n$, $M\propto{}a^{3}\rho_{\mathrm{c}}\propto\rho_{\mathrm{c}}^{\frac{3-n}{2n}}$. 因此可得 $R\propto{}M^{\frac{1-n}{3-n}}$. 非相对论情况，$n=\dfrac{3}{2}, R\propto{}M^{-\frac{1}{3}}$, 白矮星吸积物质，质量逐渐增大，反而逐渐收缩，然后升温。一直到相对论情况，$n=3, R\propto{}M^{-\infty}$, 直接坍缩。
...
\subsection{恒星的演化}
恒星通过核反应产生能量，维持热平衡和流体静力学平衡。在此过程中恒星内部的化学组成发生变化。将新的化学组成作为初始条件重新代入方程组求解，得到恒星在时间 $\d{}t$ 后的结构。依次类推，可以求得恒星的结构随时间的变化，即恒星的演化。实际上，恒星的一生是与引力斗争的一生。无论化学组分如何改变，压力来源如何变化，其最终都要试图与引力抗衡。

天文学中常用时标来估计某种物理过程的重要性，此处给出一些恒星演化中涉及的时标：

核时标，恒星核心区（约占总质量的 $10\%$) 核燃料消耗殆尽所需的时间
\begin{equation}
t_{n}=\frac{E}{L}=\frac{\eta\laplacian{}M\symup{c}^{2}}{L}\approx0.7\%\times\frac{0.1\, M_{\odot}\symup{c}^{2}}{L}\approx\qty{e10}{yr}\frac{M}{\unit{M_{\odot}}}\mleft(\frac{L}{\unit{L_{\odot}}}\mright)^{-1}.
\end{equation}

热时标，恒星辐射完自身内能所需的时间，或者光子从恒星内部到达表面的时间（根据位力定理，内能是引力能的 $\dfrac{1}{2}$)
\begin{equation}
t_{\mathrm{the}}=0.5\frac{\symup{G}M^{2}}{RL}\approx\qty{2e7}{yr}\mleft(\frac{M}{\unit{M_{\odot}}}\mright)^{2}\mleft(\frac{R}{\unit{R_{\odot}}}\mright)^{-1}\mleft(\frac{L}{\unit{L_{\odot}}}\mright)^{-1}.
\end{equation}

动力学时标，如果恒星内部压力突然消失，引力作用下恒星坍缩的时间
\begin{equation}
t_{\mathrm{dyn}}=\frac{R}{V}\approx\sqrt\frac{R^{3}}{\symup{G}M}\approx\qty{27}{min}\mleft(\frac{R}{\unit{R_{\odot}}}\mright)^{\frac{3}{2}}\mleft(\frac{M}{\unit{M_{\odot}}}\mright)^{-\frac{1}{2}}.
\end{equation}
...
&\frac{\partial\symbf{v}}{\partial{}t}+\mleft(\symbf{v}\cdot\nabla\mright)\symbf{v}=-\frac{1}{\rho}\nabla P+\symbf{F}.\\
&\frac{\d{}}{\d{}t}\mleft(\frac{P}{\rho^{\gamma}}\mright)=0.
\end{align}
对于自引力场，定义引力势 $F=-\nabla\Phi,\nabla^{2}\Phi_{0}=4\pi\symup{G}\rho_{0},\nabla P_{0}=-\rho_{0}\nabla\Phi_{0}$.
现在考虑一个小扰动
\begin{equation}
\frac{P_{0}+P_{1}}{P_{0}}=\mleft(\frac{\rho_{0}+\rho_{1}}{\rho_{0}}\mright)^{\gamma}, P_{1}=\symup{c}_{\mathrm{s}}^{2}\rho_{1},
\end{equation}
连续性方程变为
\begin{equation}
\frac{\partial\rho_{1}}{\partial{}t}+\nabla\cdot\mleft[\mleft(\rho_{0}+\rho_{1}\mright)\symbf{v}_{1}\mright]=\frac{\partial\rho_{1}}{\partial{}t}+\rho_{0}\nabla\cdot\symbf{v}_{1}=0.
\end{equation}
欧拉方程变为
\begin{equation}
\mleft(\rho_{0}+\rho_{1}\mright)\mleft[\frac{\partial\symbf{v}_{1}}{\partial t}+\mleft(\symbf{v}_{1}\cdot\nabla\mright)\symbf{v}_{1}\mright]=-\nabla\mleft(P_{0}+P_{1}\mright)+\mleft(\rho_{0}+\rho_{1}\mright)\nabla\mleft(\Phi_{0}+\Phi_{1}\mright).
\end{equation}
解得
\begin{align}
&\rho_{0}\frac{\partial\symbf{v}_{1}}{\partial t}=-\symup{c}_{\mathrm{s}}^{2}\nabla\rho_{1}-\rho_{0}\nabla\Phi_{1}.\\
&\mleft(\frac{\partial{}^{2}}{\partial{}t^{2}}-\symup{c}_{\mathrm{s}}^{2}\nabla^{2}-4\pi\symup{G}\rho_{0}\mright)\rho_{1}=0.
\end{align}
上式中，如果引力可被忽略，就是声波方程。如果压力可被忽略，$\rho_{1}\propto\exp\mleft[\sqrt{4\pi\symup{G}\rho_{0}}t\mright]$. 通过三维傅立叶变换可以看出波数和密度分布。引入流体静力学色散关系：
\begin{equation}
\omega^{2}=k^{2}\symup{c}_{\mathrm{s}}^{2}-4\pi\symup{G}\rho_{0},
\end{equation}
要让波发生演化而不是形成驻波，要求 $\omega$ 是复数。于是我们引入金斯波长
\begin{equation}
\lambda_{\mathrm{J}}=\frac{h}{p_{\mathrm{J}}}=\frac{2\pi}{\symup{k}_{\mathrm{J}}}=\sqrt{\frac{\pi\symup{c}_{\mathrm{s}}^{2}}{\symup{G}\rho_{0}}},
\end{equation}
同时有金斯质量：
\begin{equation}
M_{\mathrm{J}}=\frac{4\pi}{3}\rho\mleft(\frac{\lambda_{\mathrm{J}}}{2}\mright)^{3}\sim 2M_{\odot}\cdot\mleft(\frac{\symup{c}_{\mathrm{s}}}{\qty{0.2}{km\cdot{}s^{-1}}}\mright)^{3}\mleft(\frac{n}{\qty{e3}{cm^{-3}}}\mright)^{-\frac{1}{2}}.
\end{equation}
质量大于这个值的分子云才能坍缩。
...
\begin{equation}
\frac{\partial{}^{2}\Delta_{k}}{\partial{}t^{2}}=\mleft(2\pi\symup{G}\Sigma_{0}k-\Omega^{2}-k^{2}\symup{c}_{\mathrm{s}}^{2}\mright)\Delta_{k}.
\end{equation}
Toomre Q parameter
\begin{equation}
Q=\frac{\symup{c}_{\mathrm{s}}\Omega}{\pi\symup{G}\Sigma}<1
\end{equation}
时才会坍缩。
...
\begin{equation}
E_{\mathrm{bind}}=\frac{1}{4\pi\varepsilon_{0}}\frac{{\color{blue}{\ce{e}}}^{2}}{\alpha_{0}}=\alpha^{2}m_{0}\symup{c}^{2}.
\end{equation}
想象有一大堆聚集在一起的气体，其引力势能为
\begin{equation}
E_{\mathrm{gravity}}\sim\frac{\symup{G}M^{2}}{R}\sim\frac{\symup{G}N^{2}m_{\ce{p}}^{2}}{R}, R\sim N^{\frac{1}{3}}\alpha_{0},
\end{equation}
分子间的结合能为
\begin{equation}
...
令二者相等，得到
\begin{align}
N=\mleft(\frac{\alpha\symup{c}\hbar}{\symup{G}m_{\ce{p}}^{2}}\mright)^{\frac{3}{2}}\sim10^{54},\\
M_{\mathrm{c}}=Nm_{\ce{p}}\sim\qty{e30}{g}.
\end{align}
$M<M_{\mathrm{c}}$, 则结合能胜利，成为固态行星，否则分子间电磁力无法抗衡引力，云团将以等离子体形式存在。
...
\begin{equation}
U_{\mathrm{g}}=\frac{\symup{G}M^{2}}{R}\sim U_{\mathrm{k}}=N\symup{k}_{\mathrm{B}}T,
\end{equation}
记粒子间的距离为 $d, d=R\times N^{-\frac{1}{3}}$, 因此
\begin{equation}
T_{\mathrm{vir}}\sim N^{\frac{2}{3}}\frac{\symup{G}m_{\ce{p}}^{2}}{d},
\end{equation}
但值得注意的是，当质量足够高时，简并效应开始发挥作用，因此上式需要添加修正项，转为
\begin{equation}
T\sim N^{\frac{2}{3}}\frac{\symup{G}m_{\ce{p}^{2}}}{d}-\frac{1}{m_{0}d^{2}},
\end{equation}
对给定粒子数，$d$ 取 $2N^{-\frac{2}{3}}\mleft(m_{0}\alpha_{\mathrm{G}}\mright)^{-1}$ 时 $T$ 有最大值，其中 $\alpha_{\mathrm{G}}=\dfrac{\symup{G}m_{\ce{p}}^{2}}{\hbar\symup{c}}$:
\begin{equation}
T=N^{\frac{4}{3}}\alpha_{\mathrm{G}}^{2}m_{0}.
\end{equation}
而进行热核反应所需的温度为
\begin{equation}
T_{\mathrm{nuc}}=\eta\alpha^{2}m_{\ce{p}},
\end{equation}
可以得到临界粒子数密度为
\begin{equation}
N=\eta^{\frac{3}{4}}\mleft(\dfrac{m_{\ce{p}}}{m_{0}}\mright)^{\frac{3}{4}}\mleft(\frac{\alpha}{\alpha_{\mathrm{G}}}\mright)^{\frac{3}{2}},
\end{equation}
假定 $\eta=0.1$, 临界质量为
\begin{equation}
...
\begin{align}
\mleft(Z, A\mright)+\ce{n &->}\mleft(Z, A+1\mright)+\gamma,\\
\mleft(Z, A+1\mright)\ce{&->}\mleft(Z+1, A+1\mright)+\ce{e-}+\overline{\nu}_{\ce{e}}.
\end{align}
...
\begin{tabular}{c c}
\hline
恒星初始质量 $\mleft(\unit{M_{\odot}}\mright)$ & 演化结局\\
\cline{1-2}
<0.01 & 行星\\
\cline{1-2}
...
branch, RGB) & 壳层氢燃烧产能率上升，半径上升，& 攀升成为红巨星\\
 & 温度下降，恒星对流区增大 & \\
\cline{1-3}
氦闪 & $T_{\mathrm{c}}$ 达到 $\qty{e8}{K}$ 时氦开始燃烧，& 攀升到红巨星支的顶点\\
...
(HB) & & \\
\cline{1-3}
渐近巨星支 & 氦核燃烧殆尽，留下 $\ce{CO}$ 核，$R_{\mathrm{c}}\downarrow, T_{\mathrm{c}}\uparrow$ & 再次向右上方攀升\\
...
(thermal pulse) & 红巨星包层物质抛射 ($25\text{\textendash}60\%$ 恒星质量）& \\
 & 形成行星状星云和高温简并 $\ce{CO}$ 核 & \\
\cline{1-3}
白矮星 & 恒星外包层完全抛射，留下高温简并 $\ce{CO}$ 核 & 向左下方移动至白矮星区\\
...
\text{Roche 势}\,\Phi\mleft(r\mright)&=-\frac{\symup{G}M_{1}}{\mleft\vert\symbf{r}-\symbf{r}_{1}\mright\vert{}}-\frac{\symup{G}M_{2}}{\mleft\vert\symbf{r}-\symbf{r}_{2}\mright\vert{}}-\frac{1}{2}\mleft(\symbf{\omega}\times\symbf{r}\mright)^{2}.
\end{align}
如果我们考虑椭圆轨道表达式
\begin{equation}
r=\frac{a\mleft(1-e^{2}\mright)}{1+e\cos{\mleft(\theta-\omega\mright)}},
\end{equation}
并假设偏心率 $e=0$, 两天体质量比 $q$, 那么
\begin{align}
\symbf{r}_{1}&=\mleft(-\frac{q}{1+q}a, 0, 0\mright),\symbf{r}_{2}=\mleft(\frac{1}{1+q}a, 0, 0\mright),\\
\symbf{\Phi}&=-\frac{1}{1+q}\frac{\symup{G}M_{\mathrm{total}}}{\mleft\vert\symbf{r}-\mleft(-\dfrac{q}{1+q}a, 0, 0\mright)\mright\vert{}}-\frac{q}{1+q}\frac{\symup{G}M_{\mathrm{total}}}{\mleft\vert\symbf{r}-\mleft(\dfrac{1}{1+q}a, 0, 0\mright)\mright\vert{}}-\frac{1}{2}\frac{\symup{G}M_{\mathrm{total}}}{a^{3}}r^{2}.
\end{align}
...
白矮星基本参数：
质量 $\sim0.2\text{\textendash}\qty{1.3}{M_{\odot}}$, 半径 $\sim5\times10^{8}\text{\textendash}\qty{e9}{cm}$, 密度 $\sim10^{5}\text{\textendash}\qty{e7}{g\cdot cm^{-3}}$, 绝对星等 $M_{\mathrm{V}}\sim8\text{\textendash}16$, 有效温度 $\sim5\times10^{3}\text{\textendash}\qty{4e4}{K}$, 自转周期 $\ge\qty{10}{s}$. 外层包裹着厚度约 $\qty{50}{km}$, 主要由氢组成的大气。
...
随着白矮星质量增大，白矮星质量增大，简并气体运动变成相对论性。此时引力 $\dfrac{\symup{G}\rho{}M}{R^{2}}\propto\dfrac{M^{2}}{R^{5}}$ 比压力 $\dfrac{\d{}P}{\d{}R}\propto\dfrac{\rho^{\frac{4}{3}}}{R}\propto\dfrac{M^{\frac{4}{3}}}{R^{5}}$ 增长得更快，因此白矮星有质量上限。
...
随着费米动量越来越高，$E_{F}=\sqrt{p_{\mathrm{F}}^{2}\symup{c}^{2}+m_{{\color{blue}{\ce{e}}}}^{2}\symup{c}^{4}}>\mleft(m_{\ce{n}}-m_{\ce{p}}-m_{{\color{blue}{\ce{e}}}}\mright)\symup{c}^{2}$, 从而生成中子。临界动量和密度为
\begin{align}
p_{\mathrm{F}}&=m_{{\color{blue}{\ce{e}}}}\symup{c}\mleft[\mleft(\frac{m_{\ce{n}}-m_{\ce{p}}}{m_{{\color{blue}{\ce{e}}}}}\mright)^{2}-1\mright]^{\frac{1}{2}}.\\
\rho&\sim\qty{1.2e10}{kg\cdot m^{-3}}.
\end{align}
等密度达到 $\qty{e18}{kg\cdot m^{-3}}$ 的量级，最终产生半径 $\qty{10}{km}$ 的中子星。中子星的特征质量为 $\qty{1.4}{M_{\odot}}$.

中子星质量估计：考虑质子德布罗意波长和普朗克质量 $m_{\mathrm{planck}}=\sqrt{\dfrac{\hbar\symup{c}}{\symup{G}}}$, 估计得到半径上限 $R_{\max}\sim\dfrac{m_{\mathrm{planck}}}{m_{\ce{p}}}\times\lambda_{n}\sim\qty{10}{km}$, 粒子数上限 $N\sim\mleft(\dfrac{m_{\mathrm{planck}}}{m_{\ce{p}}}\mright)^{3}\sim2.2\times10^{57}$, 质量上限 $M_{\max}\sim Nm_{\ce{p}}\sim M_{\odot}$, 密度上限 $\rho_{\max}\sim\dfrac{m_{\ce{p}}}{\lambda_{n}}\sim\qty{e18}{kg\cdot m^{-3}}$.
...
\begin{equation}
U_{\mathrm{g}}\sim\frac{\symup{G}M^{2}}{R}=2.7\times10^{53}\,\unit{erg}\mleft(\frac{M}{\unit{M_{\odot}}}\mright)^{2}\mleft(\frac{R}{\qty{10}{km}}\mright)^{-1},
\end{equation}
然后是转动动能
\begin{align}
U_{\mathrm{rot}}&\sim M\Omega^{2}R^{2}\sim7.9\times10^{52}\,\unit{erg}\mleft(\frac{M}{\unit{M_{\odot}}}\mright)\mleft(\frac{R}{\qty{10}{km}}\mright)^{2}\mleft(\frac{\nu}{\qty{1000}{Hz}}\mright)^{2}.\\
\frac{U_{\mathrm{rot}}}{U_{\mathrm{g}}}&=0.3\mleft(\frac{M}{\unit{M_{\odot}}}\mright)^{-1}\mleft(\frac{R}{\qty{10}{km}}\mright)^{3}\mleft(\frac{\nu}{\qty{1000}{Hz}}\mright)^{2}.
\end{align}
接着是磁能
\begin{align}
B&\sim1.8\times10^{18}\,\unit{G}\mleft(\frac{M}{\qty{1.4}{M_{\odot}}}\mright)\mleft(\frac{R}{\qty{10}{km}}\mright)^{-2},\\
U_{\mathrm{B}}&=\frac{4}{3}\pi{}R^{3}\frac{B^{2}}{8\pi},\notag\\
\frac{U_{\mathrm{B}}}{U_{\mathrm{g}}}&\sim3\times10^{-13}\mleft(\frac{M}{\qty{1.4}{M_{\odot}}}\mright)^{-2}\mleft(\frac{R}{\qty{10}{km}}\mright)^{4}\mleft(\frac{B}{\qty{e12}{G}}\mright)^{2}.
\end{align}

与通常恒星相比中子星的温度很高，但相对于中子星物质的高密度而言，它可以非常好地用零温近似描述，因此费米能为
\begin{align}
\varepsilon_{\mathrm{Feimi}}&=\frac{P_{\mathrm{F}}^{2}}{2m_{\ce{n}}}=\frac{h^{2}}{2m_{\ce{n}}}\mleft(\frac{3n}{8\pi}\mright)^{\frac{2}{3}}=\qty{30}{MeV}\mleft(\frac{\rho}{\qty{e14}{g\cdot cm^{-3}}}\mright)^{\frac{2}{3}}\gg\symup{k}_{\mathrm{B}}T.\\
E_{\mathrm{F}}&=\qty{1.64e53}{erg}\mleft(\frac{M}{\unit{M_{\odot}}}\mright)^{\frac{5}{3}}\mleft(\frac{R}{\qty{10}{km}}\mright)^{-2}.
\end{align}
...
\begin{equation}
\d{}s^{2}=\mleft(-1+\frac{2\symup{G}M}{r\symup{c}^{2}}\mright)\symup{c}^{2}\d{}t^{2}+\frac{1}{1-\dfrac{2\symup{G}M}{r\symup{c}^{2}}}\d{}r^{2}+r^{2}\mleft(\d\theta^{2}-\sin^{2}{\theta}\d\phi^{2}\mright).
\end{equation}

视界：半径为史瓦西半径 $R_{\mathrm{s}}$ 的球面，在视界内的任何信息都无法向外传递

光层：半径为 $1.5R_{\mathrm{s}}$ 的球面，在光层各向同性辐射光子中的一半可以逃逸

\subsubsection{Kerr}
对角动量为 $J$ 的黑洞，记 $m=\dfrac{\symup{G}M}{\symup{c}^{2}}, a=\dfrac{J}{M\symup{c}}$, 视界半径为
\begin{equation}
r_{\mathrm{h}}=\mleft(\frac{R_{\mathrm{s}}}{2}\mright)\mleft[m+\sqrt{m^{2}-a^{2}}\mright].
\end{equation}
能层为
\begin{equation}
r_{\mathrm{st}}=\mleft(\frac{R_{\mathrm{s}}}2\mright)\mleft[m+\sqrt{m^{2}-a^{2}\cos^{2}{\theta}}\mright].
\end{equation}
能层：介于 $r_{\mathrm{h}}$ 和 $r_{\mathrm{st}}$ 之间的区域。
...
根据黑洞能损率推测黑洞寿命
\begin{equation}
t=\frac{E}{L}=\frac{M\symup{c}^{2}}{4\pi R_{\mathrm{s}}^{2}\sigma T^{4}}\propto{}M^{3}
\end{equation}
...
假设行星是黑体，能量全部来自太阳，得到
\begin{align}
&\frac{L_{\odot}}{4\pi R^{2}_{\odot\to\mathrm{planet}}}\pi R_{\mathrm{planet}}^{2}\times\mleft(1-a\mright)=4\pi R_{\mathrm{planet}}^{2}\sigma_{\mathrm{SB}}T_{\mathrm{planet}}^{4}.\\
&T_{\mathrm{eq}}=\mleft(1-a\mright)^{\frac{1}{4}}\sqrt{\frac{R_{\odot}}{2R_{\odot\to\mathrm{planet}}}}T_{\odot}.
\end{align}
可借此估计行星温度，其中 $a$ 是反照率。

如果大气对短波长的太阳光透明但对长波长的热辐射不透明，会发生什么？恒星入射 $P_{\mathrm{s}}$ 等于大气向外辐射 $P_{2}$. 对地球表面，大气也向地面辐射 $P_{2}$, 因此 $P_{\mathrm{s}}+P_{2}=P_{\text{surface}}$. 大气只吸收地面辐射，因此 $2P_{2}=P_{\text{surface}}$. 联立这些式子得到地面温度为
\begin{equation}
T_{\text{surface}}=2^{-\frac{1}{4}}T_{\mathrm{s}}.
\end{equation}
温室效应恐怖如斯。
...
\begin{align}
\frac{\symup{G}M_{1}M_{2}}{\mleft(r_{1}+r_{2}\mright)^{2}}=M_{1}r_{1}\omega^{2}=M_{2}r_{2}\omega^{2}.\\
\symup{G}\frac{M_{2}^{3}}{\mleft(M_{1}+M_{2}\mright)^{2}}=r_{1}^{3}\omega^{2}=v_{1}^{3}\frac{T}{2\pi}.\\
M_{\mathrm{p}}\ll M_{1}, M_{\mathrm{p}}=v_{1}M_{1}^{\frac{2}{3}}\mleft(\frac{T}{2\pi\symup{G}}\mright)^{\frac{1}{3}}.
\end{align}

还要考虑倾角
\begin{equation}
M_{\mathrm{p}}\sin{i}=v_{1,\mathrm{obs}}M_{1}^{\frac{2}{3}}\mleft(\frac{T}{2\pi\symup{G}}\mright)^{\frac{1}{3}}.
\end{equation}
轨道倾角 $i$ 并非随机分布。考虑立体角积分方式，实际上是正弦分布。

此外还要考虑选择效应：
\begin{equation}
v_{1,\mathrm{obs}}=\symup{G}^{\frac{1}{2}}M_{1}^{-\frac{1}{2}}M_{\mathrm{p}}r_{\mathrm{p}}^{-\frac{1}{2}}\sin{i}.
\end{equation}
...
\begin{equation}
\alpha=\frac{4\symup{G}M}{\symup{c}^{2}b}=\frac{2R_{\mathrm{s}}}{b}.
\end{equation}
记源到透镜距离为 $D_{\mathrm{sl}}$, 透镜到观测者距离为 $D_{\mathrm{lo}}$, 入射距离对观测者张角为 $\theta_{\mathrm{E}}$, 像到源的距离为 $D_{\mathrm{is}}$, 都是小量，于是有
\begin{align}
D_{\mathrm{is}}&=D_{\mathrm{so}}\theta_{\mathrm{E}}=D_{\mathrm{sl}}\alpha.\\
...
\begin{equation}
\theta^{2}-\beta\theta-\theta_{\mathrm{E}}^{2}=0.
\end{equation}

透镜会放大相，放大率满足
\begin{align}
a_{\pm}=\frac{\theta_{\pm}}{\beta}\frac{\d\theta_{\pm}}{\d\beta}=\frac{\theta_{\pm}}{\beta}\mleft[1\pm\frac{\beta}{\mleft(\beta^{2}+4\theta_{\mathrm{E}}^{2}\mright)^{\frac{1}{2}}}\mright].\\
a_{\mathrm{total}}=a_{+}+a_{-}=\frac{u^{2}+2}{u\mleft(u^{2}+4\mright)^{\frac{1}{2}}}, u=\frac{\beta}{\theta_{\mathrm{E}}}.
\end{align}

对于系外源我们忽视 $\beta$ 的变化，我们会考虑恒星穿越透镜区域
\begin{equation}
\beta\mleft(t\mright)=\mleft[\beta_{0}^{2}+\frac{v^{2}}{D_{\mathrm{lo}}^{2}}\mleft(t-t_{0}\mright)^{2}\mright]^{\frac{1}{2}}.
\end{equation}
因此会产生光变曲线。光变时标
\begin{equation}
\tau=\frac{\theta_{\mathrm{E}}D_{\mathrm{lo}}}{v}.
\end{equation}

如果透镜附近有个小行星，行星的透镜会让光变曲线会变成一大一小的叠加。其他参数是一致的，那么光变曲线的时标比会给出质量比
\begin{equation}
\frac{\tau_{\mathrm{p}}}{\tau_{\mathrm{star}}}=\frac{\theta_{\mathrm{p}}}{\theta_{\mathrm{star}}}=\mleft(\frac{M_{\mathrm{p}}}{M_{\mathrm{star}}}\mright)^{\frac{1}{2}}.
\end{equation}
...
引力差距
\begin{equation}
\laplacian{}F=\frac{\symup{G}Mm}{r^{2}}\mleft(\cos{\phi}\mleft(1+\frac{2R}{r}\cos{\theta}\mright)-1\mright)\hat{i}-\frac{\symup{G}Mm}{r^{2}}\mleft(1+\frac{2R}{r}\cos{\theta}\mright)\sin{\phi}\hat{j}.
\end{equation}
其中 $\phi$ 是被引力体表面某点与引力体中心连线，相对二引力体中心连线的夹角。该式表明，被引力体赤道延伸，两极压缩。

潮汐力会引起天体解体
\begin{equation}
\frac{2\symup{G}M_{\mathrm{p}}R_{\mathrm{m}}}{r^{3}}>\frac{\symup{G}M_{\mathrm{m}}}{R_{\mathrm{m}}^{2}}, r<2^{\frac{1}{3}}\mleft(\frac{M_{\mathrm{p}}}{M_{\mathrm{m}}}\mright)^{\frac{1}{3}}R_{\mathrm{m}}.
\end{equation}
其中 $R_{\mathrm{m}}$ 是卫星半径。
