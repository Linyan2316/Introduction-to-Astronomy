...
\begin{align}
\frac{1}{2}m_{\ce{H}}v^{2}&=\frac{3}{2}k_{\mathrm{B}}T_{\mathrm{classical}}=\frac{1}{4\pi\varepsilon_{0}}\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}}{r},\\
T_{\mathrm{classical}}&=\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}}{6\pi\varepsilon_{0}k_{\mathrm{B}}r}\sim\qty{e10}{K}.
\end{align}
...
T_{\mathrm{quantum}}&=\frac{Z_{1}^{2}Z_{2}^{2}{\color{blue}{\ce{e}}}^{4}m_{\ce{H}}}{12\pi^{2}\varepsilon_{0}^{2}k_{\mathrm{B}}h^{2}}\sim\qty{e7}{K}.
\end{align}
...
\end{equation}
因此太阳平均温度可达 $T=\dfrac{\mu m_{\ce{H}}\overline{P}}{k_{\mathrm{B}}\rho}\sim\qty{5e6}{K}$, 核心温度可达 $\qty{1.5e7}{K}$, 因此仅凭借云团坍缩过程中所释放的引力能就足以达到支持热核反应所需要的高温。
...
首先 Maxwell 速度分布为
\begin{align}
f\mleft(v\mright)\d{}v&=\mleft(\frac{m}{2\pi{}k_{\mathrm{B}}T}\mright)^{\frac{3}{2}}\exp\mleft(-\frac{mv^{2}}{2k_{\mathrm{B}}T}\mright) 4\pi v^{2}\d{}v,\\
f\mleft(E\mright)\d{}E&=\frac{2}{\sqrt{\pi}}\frac{E^{\frac{1}{2}}}{\mleft(k_{\mathrm{B}}T\mright)^{\frac{3}{2}}\exp\mleft(-\dfrac{E}{k_{\mathrm{B}}T}\mright)}\d{}E.
\end{align}
...
&=n_{1}n_{2}\frac{2^{\frac{3}{2}}}{\mleft(\pi m\mright)^{\frac{1}{2}}}\frac{1}{\mleft(k_{\mathrm{B}}T\mright)^{\frac{3}{2}}}\int_{0}^{\infty}S\mleft(E\mright)\exp\mleft(-\frac{E_{\mathrm{G}}^{\frac{1}{2}}}{E^{\frac{1}{2}}}\mright)\exp\mleft(-\frac{E}{k_{\mathrm{B}}T}\mright)\d{}E.
\end{align}
观察上式可知在某个能量处反应速率最大，也就是 Gamow Peak:
\begin{equation}
E_{0}=\mleft[\mleft(\frac{m}{2}\mright)^{\frac{1}{2}}\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}k_{\mathrm{B}}T}{4\varepsilon_{0}\hbar}\mright]^{\frac{2}{3}}=\mleft(\frac{E_{\mathrm{G}}^{\frac{1}{2}}k_{\mathrm{B}}T}{2}\mright)^{\frac{2}{3}}.
\end{equation}
看表达式可知 $E_{0}$ 是热能 $k_{\mathrm{B}}T$ 和 $E_{\mathrm{G}}$ 按照 $2: 1$ 的几何平均。
...
\begin{equation}
r\propto{}n_{1}n_{2}\frac{S\mleft(E_{0}\mright)}{T^{\frac{2}{3}}}\exp\mleft[-3\mleft(\frac{{\color{blue}{\ce{e}}}^{4}}{32\varepsilon_{0}^{2}k_{\mathrm{B}}\hbar^{2}}\frac{mZ_{1}^{2}Z_{2}^{2}}{T}\mright)^{\frac{1}{3}}\mright].
\end{equation}

于是我们可以定义聚变效率 $C$, 一般用实验而不是计算确定。最后可借此得到单位体积的能量产生率 $\varepsilon$
\begin{align}
r\laplacian\varepsilon&=\rho\varepsilon.\\
&\varepsilon=C\rho X_{1}X_{2}\frac{1}{T^{\frac{2}{3}}}\exp\mleft[-3\mleft(\frac{{\color{blue}{\ce{e}}}^{4}}{32\varepsilon_{0}^{2}k_{\mathrm{B}}\hbar^{2}}\frac{mZ_{1}^{2}Z_{2}^{2}}{T}\mright)^{\frac{1}{3}}\mright].
\end{align}
...
\end{equation}
对于理想气体而言，气压 $P=n{}k_{\mathrm{B}}T$, 内能 $E_{\mathrm{T}}=\dfrac{3}{2}nk_{\mathrm{B}}T$, 因此 $3P=2E_{\mathrm{T}}$, 上式积分左侧结果为 $-2U_{\mathrm{T}}$, 而右侧正是引力能 $U_{\mathrm{g}}$, 因此恒星总能量为 $U_{\mathrm{total}}=U_{\mathrm{T}}+U_{\mathrm{g}}=\dfrac{1}{2}U_{\mathrm{g}}=-U_{\mathrm{T}}$, 恒星温度升高，动能上高，总能量反而下降，因此恒星是个负热容系统。
...
\begin{equation}
P_{\mathrm{g}}=\frac{\rho{}k_{\mathrm{B}}T}{\mu m_{\ce{H}}}.
\end{equation}
...
\begin{equation}
P_{\mathrm{g}}=n_{{\color{blue}{\ce{e}}}}k_{\mathrm{B}}T+\sum_{i}n_{i}k_{\mathrm{B}}T=\sum_{i}\mleft(Z_{i}+1\mright) n_{i}k_{\mathrm{B}}T=\sum_{i}\mleft(1+Z_{i}\mright)\frac{\rho\chi_{i}k_{\mathrm{B}}T}{A_{i}m_{\ce{H}}}=\frac{\rho{}k_{\mathrm{B}}T}{\mu m_{\ce{H}}}.
\end{equation}
因此相对分子量为
\begin{equation}
...
\begin{equation}
P_{\mathrm{g}}=\rho{}k_{\mathrm{B}}T\frac{2X+\dfrac{3}{4}Y+\dfrac{1}{2}Z}{m_{\ce{H}}}.
\end{equation}

有时候我们不考虑电子气体的贡献，即只有一大堆离子，那么
\begin{align}
\frac{1}{\mu}&=\sum_{i}\frac{\chi_{i}}{A_{i}}\\
P_{\mathrm{g}}&=\rho{}k_{\mathrm{B}}T\frac{X+\dfrac{1}{4}Y}{m_{\ce{H}}}.
\end{align}
...
\mleft.\frac{\d{}T}{\d{}r}\mright\vert_{\mathrm{ad}}&=\mleft(1-\frac{1}{\gamma}\mright)\frac{T}{P}\frac{\d{}P}{\d{}r}=-\mleft(1-\frac{1}{\gamma}\mright)\frac{\mu m_{\ce{H}}}{k_{\mathrm{B}}}\frac{\symup{G}M_{r}}{r^{2}}.
\end{align}
...
现在考虑一个小扰动
\begin{equation}
\frac{P_{0}+P_{1}}{P_{0}}=\mleft(\frac{\rho_{0}+\rho_{1}}{\rho_{0}}\mright)^{\gamma}, P_{1}=c_{\mathrm{s}}^{2}\rho_{1},
\end{equation}
连续性方程变为
\begin{equation}
...
解得
\begin{align}
&\rho_{0}\frac{\partial\symbf{v}_{1}}{\partial t}=-c_{\mathrm{s}}^{2}\nabla\rho_{1}-\rho_{0}\nabla\Phi_{1}.\\
&\mleft(\frac{\partial{}^{2}}{\partial{}t^{2}}-c_{\mathrm{s}}^{2}\nabla^{2}-4\pi\symup{G}\rho_{0}\mright)\rho_{1}=0.
\end{align}
上式中，如果引力可被忽略，就是声波方程。如果压力可被忽略，$\rho_{1}\propto\exp\mleft[\sqrt{4\pi\symup{G}\rho_{0}}t\mright]$. 通过三维傅立叶变换可以看出波数和密度分布。引入流体静力学色散关系：
\begin{equation}
\omega^{2}=k^{2}c_{\mathrm{s}}^{2}-4\pi\symup{G}\rho_{0},
\end{equation}
要让波发生演化而不是形成驻波，要求 $\omega$ 是复数。于是我们引入金斯波长
\begin{equation}
\lambda_{\mathrm{J}}=\frac{h}{p_{\mathrm{J}}}=\frac{2\pi}{\symup{k}_{\mathrm{J}}}=\sqrt{\frac{\pi{}c_{\mathrm{s}}^{2}}{\symup{G}\rho_{0}}},
\end{equation}
同时有金斯质量：
\begin{equation}
M_{\mathrm{J}}=\frac{4\pi}{3}\rho\mleft(\frac{\lambda_{\mathrm{J}}}{2}\mright)^{3}\sim 2M_{\odot}\cdot\mleft(\frac{c_{\mathrm{s}}}{\qty{0.2}{km\cdot{}s^{-1}}}\mright)^{3}\mleft(\frac{n}{\qty{e3}{cm^{-3}}}\mright)^{-\frac{1}{2}}.
\end{equation}
质量大于这个值的分子云才能坍缩。
...
\begin{equation}
\frac{\partial{}^{2}\Delta_{k}}{\partial{}t^{2}}=\mleft(2\pi\symup{G}\Sigma_{0}k-\Omega^{2}-k^{2}c_{\mathrm{s}}^{2}\mright)\Delta_{k}.
\end{equation}
Toomre Q parameter
\begin{equation}
Q=\frac{c_{\mathrm{s}}\Omega}{\pi\symup{G}\Sigma}<1
\end{equation}
时才会坍缩。
...
\begin{equation}
U_{\mathrm{g}}=\frac{\symup{G}M^{2}}{R}\sim U_{\mathrm{k}}=Nk_{\mathrm{B}}T,
\end{equation}
...
\begin{align}
\varepsilon_{\mathrm{Feimi}}&=\frac{P_{\mathrm{F}}^{2}}{2m_{\ce{n}}}=\frac{h^{2}}{2m_{\ce{n}}}\mleft(\frac{3n}{8\pi}\mright)^{\frac{2}{3}}=\qty{30}{MeV}\mleft(\frac{\rho}{\qty{e14}{g\cdot cm^{-3}}}\mright)^{\frac{2}{3}}\gg{}k_{\mathrm{B}}T.\\
