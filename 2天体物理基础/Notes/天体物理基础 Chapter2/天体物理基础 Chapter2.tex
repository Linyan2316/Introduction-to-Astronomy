...
\begin{align}
\d{}U_{\text{g}, i}&=-\symup{G}\frac{M_{r}\d{}m_{i}}{r},\notag\\
U_{\text{g}}&=-\symup{G}\int_{0}^{R}\frac{4}{3}\pi r^{3}\rho \frac{4\pi r^{2}\rho\d{}r}{r}\notag\\
...
\begin{align}
\frac{1}{2}m_{\ce{H}}v^{2}&=\frac{3}{2}k_{\symup{B}}T_{\text{classical}}=\frac{1}{4\pi\varepsilon_{0}}\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}}{r},\\
T_{\text{classical}}&=\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}}{6\pi\varepsilon_{0}k_{\symup{B}}r}\sim\qty{e10}{K}.
\end{align}
...
T_{\text{quantum}}&=\frac{Z_{1}^{2}Z_{2}^{2}{\color{blue}{\ce{e}}}^{4}m_{\ce{H}}}{12\pi^{2}\varepsilon_{0}^{2}k_{\symup{B}}h^{2}}\sim\qty{e7}{K}.
\end{align}
...
&=n_{1}n_{2}\frac{2^{\frac{3}{2}}}{\left(\pi m\right)^{\frac{1}{2}}}\frac{1}{\left(k_{\symup{B}}T\right)^{\frac{3}{2}}}\int_{0}^{\infty}S\left(E\right)\exp\left(-\frac{E_{\text{G}}^{\frac{1}{2}}}{E^{\frac{1}{2}}}\right)\exp\left(-\frac{E}{k_{\symup{B}}T}\right)\d{}E.
\end{align}
观察上式可知在某个能量处反应速率最大，也就是 Gamow Peak:
\begin{equation}
E_{0}=\left[\left(\frac{m}{2}\right)^{\frac{1}{2}}\frac{Z_{1}Z_{2}{\color{blue}{\ce{e}}}^{2}k_{\symup{B}}T}{4\varepsilon_{0}\hbar}\right]^{\frac{2}{3}}=\left(\frac{E_{\text{G}}^{\frac{1}{2}}k_{\symup{B}}T}{2}\right)^{\frac{2}{3}}.
\end{equation}
看表达式可知 $E_{0}$ 是热能 $k_{\symup{B}}T$ 和 $E_{\text{G}}$ 按照 $2: 1$ 的几何平均。
...
\end{equation}
对于理想气体而言，气压 $P=nk_{\symup{B}}T$, 内能 $E_{\text{T}}=\dfrac{3}{2}nk_{\symup{B}}T$, 因此 $3P=2E_{\text{T}}$, 上式积分左侧结果为 $-2U_{\text{T}}$, 而右侧正是引力能 $U_{\text{g}}$, 因此恒星总能量为 $U_{\text{total}}=U_{\text{T}}+U_{\text{g}}=\dfrac{1}{2}U_{\text{g}}=-U_{\text{T}}$, 恒星温度升高，动能上高，总能量反而下降，因此恒星是个负热容系统。
...
\begin{equation}
P_{\text{g}}=\frac{\rho k_{\symup{B}}T}{\mu m_{\ce{H}}}.
\end{equation}
...
\begin{equation}
P_{\text{g}}=n_{{\color{blue}{\ce{e}}}}k_{\symup{B}}T+\sum_{i}n_{i}k_{\symup{B}}T=\sum_{i}\left(Z_{i}+1\right)n_{i}k_{\symup{B}}T=\sum_{i}\left(1+Z_{i}\right)\frac{\rho\chi_{i}k_{\symup{B}}T}{A_{i}m_{\ce{H}}}=\frac{\rho k_{\symup{B}}T}{\mu m_{\ce{H}}}.
\end{equation}
因此相对分子量为
\begin{equation}
...
\begin{equation}
P_{\text{g}}=\rho k_{\symup{B}}T\frac{2X+\dfrac{3}{4}Y+\dfrac{1}{2}Z}{m_{\ce{H}}}.
\end{equation}

有时候我们不考虑电子气体的贡献，即只有一大堆离子，那么
\begin{align}
\frac{1}{\mu}&=\sum_{i}\frac{\chi_{i}}{A_{i}}\\
P_{\text{g}}&=\rho k_{\symup{B}}T\frac{X+\dfrac{1}{4}Y}{m_{\ce{H}}}.
\end{align}
...
\begin{equation}
n_{{\color{blue}{\ce{e}}}}=\int_{0}^{p_{\text{F}}}\frac{8\pi}{h^{3}}p^{2}\d{}p=\frac{8\pi}{3h^{3}}p_{\text{F}}^{3},
\end{equation}
那么反过来讲，已知电子数密度就知道了动量的最高分布，可借此确定积分限，代入 (\ref{2.1.37}) 式得到
\begin{equation}
P=\frac{1}{3}\int_{0}^{p_{\text{F}}}vp\frac{2}{h^{3}}4\pi p^{2}\d{}p.
\end{equation}
根据狭义相对论，$v=\dfrac{p}{\gamma m}=\dfrac{p\symup{c}^{2}}{\sqrt{p^{2}\symup{c}^{2}+m^{2}\symup{c}^{4}}}$, 于是有
\begin{equation}
P=\frac{8\pi}{3}\int_{0}^{p_{\text{F}}}\frac{p^{4}\symup{c}^{2}}{\sqrt{p^{2}\symup{c}^{2}+m^{2}\symup{c}^{4}}}\d{}p.\label{2.1.46}
\end{equation}
...
\begin{equation}
\frac{\d{}T}{\d{}r}=\left.\frac{\d{}T}{\d{}r}\right\vert_{\text{rad}}+\left.\frac{\d{}T}{\d{}r}\right\vert_{\text{conv}}.
\end{equation}

首先考虑辐射部分。其实我们已经推导过了，在介绍 Eddington 光度时就考虑过辐射压和引力的平衡，在推导质光关系时将其扩展得到
\begin{equation}
\frac{\symup{G}M}{r^{2}}=\frac{1}{\rho}\frac{\d{}P}{\d{}r}=\frac{1}{\symup{c}}\kappa\frac{L}{4\pi r^{2}}=\frac{1}{\rho}\frac{4}{3}a_{\text{B}}T^{3}\frac{\d{}T}{\d{}r},\tag{\ref{1.4.11}}
\end{equation}
稍作整理并修正下正负号便是所需要的方程
\begin{equation}
\frac{\d{}T}{\d{}r}=-\frac{3}{4a_{\text{B}}\symup{c}}\frac{\kappa\rho}{T^{3}}\frac{L_{r}}{4\pi r^{2}}.\label{2.1.68}
\end{equation}
...
\end{equation}
定义 Rosseland Mean $\alpha_{\text{R}}=\dfrac{\int\dfrac{\d{}P_{\nu}}{\d{}z}d\nu}{\int\dfrac{1}{\alpha_{\nu}}\dfrac{\d{}P_{\nu}}{\d{}z}d\nu}$, 得到
\begin{equation}
F=-\frac{\symup{c}}{\alpha_{\text{R}}}\frac{\d{}P}{\d{}z},
\end{equation}
...
\begin{equation}
F=-\frac{\symup{c}}{\alpha_{\text{R}}}\frac{\d{}}{\d{}z}\left(\frac{a_{\text{B}}}{3}T^{4}\right).
\end{equation}
最后由于 $\alpha_{\text{R}}=\rho\kappa, L_{r}=4\pi{}r^{2}F$,
\begin{equation}
\frac{\d{}T}{\d{}r}=-\frac{3}{4a_{\text{B}}\symup{c}}\frac{\rho\kappa}{T^{3}}\frac{L_{r}}{4\pi{}r^{2}}.
\end{equation}
...
\left.\frac{\d{}T}{\d{}r}\right\vert_{\text{ad}}&=\left(1-\frac{1}{\gamma}\right)\frac{T}{P}\frac{\d{}P}{\d{}r}=-\left(1-\frac{1}{\gamma}\right)\frac{\mu m_{\ce{H}}}{k_{\symup{B}}}\frac{\symup{G}M_{r}}{r^{2}}.
\end{align}
我们认为 $\left\vert\dfrac{\d{}T}{\d{}r}\right\vert_{\text{actual}}<\left\vert\dfrac{\d{}T}{\d{}r}\right\vert_{\text{ad}}$ 的是辐射区，反之是对流区。
...
\begin{equation}
M=\int_{0}^{R}4\pi{}r^{2}\rho\d{}r=4\pi{}a^{3}\rho_{\text{c}}\int_{0}^{\xi_{1}}\xi^{2}\theta^{n}\d\xi,
\end{equation}
...
\begin{equation}
U_{\text{g}}=\frac{\symup{G}M^{2}}{R}\sim U_{\text{k}}=Nk_{\symup{B}}T,
\end{equation}
...
\begin{align}
\varepsilon_{\text{Feimi}}&=\frac{P_{\text{F}}^{2}}{2m_{\ce{n}}}=\frac{h^{2}}{2m_{\ce{n}}}\left(\frac{3n}{8\pi}\right)^{\frac{2}{3}}=\qty{30}{MeV}\left(\frac{\rho}{\qty{e14}{g\cdot cm^{-3}}}\right)^{\frac{2}{3}}\gg k_{\symup{B}}T.\\
...
透镜会放大相，放大率满足
\begin{align}
a_{\pm}=\frac{\theta_{\pm}}{\beta}\frac{\d\theta_{\pm}}{\d\beta}=\frac{\theta_{\pm}}{\beta}\left[1\pm\frac{\beta}{\left(\beta^{2}+4\theta_{\text{E}}^{2}\right)^{\frac{1}{2}}}\right].\\
