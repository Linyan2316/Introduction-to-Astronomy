...
&\frac{\d{}^{2}\delta}{\d{}t^{2}}+2\mleft(\frac{\dot a}{a}\mright)\frac{\d\delta}{\d{}t}-\delta\mleft(4\pi\symup{G}\rho_{0}-k^{2}c_{\mathrm{s}}^{2}\mright)=0.\label{6.5.4}
\end{align}
...
辐射主导时，
\begin{equation}
\frac{\d{}^{2}\delta}{\d{}t^{2}}+2\mleft(\frac{\dot a}{a}\mright)\frac{\d\delta}{\d{}t}-\delta\mleft(\frac{32}{3}\pi\symup{G}\rho-k^{2}c_{\mathrm{s}}^{2}\mright)=0.
\end{equation}
