...
\begin{align}
\delta{}\left(\vec{x}\right)&=\frac{1}{\left(2\pi\right)^{\frac{3}{2}}}\int\delta{}\left(\vec{k}\right)\symup{e}^{-i\symbf{k}\cdot\symbf{x}}\symup{d}^{3}\vec{k}.\\
\delta{}\left(\vec{k}\right)&=\frac{1}{\left(2\pi\right)^{\frac{3}{2}}}\int\delta{}\left(\vec{x}\right)\symup{e}^{i\symbf{k}\cdot\symbf{x}}\symup{d}^{3}\vec{x}.
\end{align}
定义物质扰动满足
\begin{align}
