...
计算光深
\begin{equation}
\tau\left(z\right)=\int_{0}^{z}n_{{\color{blue}{\ce{e}}}}\left(z\right)\chi\left(z\right)\sigma_{\text{T}}\frac{\d{}l}{\d{}z}\d{}z.
\end{equation}
$n_{{\color{blue}{\ce{e}}}}$ 和 $\dfrac{\d{}l}{\d{}z}$ 依赖于 $\Omega_{\text{b}},\Omega_{\text{m}}$ 和 $h_{70}^{2}$, 因此积分结果最后只和 $z$ 有关
\begin{equation}
...
&\frac{\d{}^{2}\delta}{\d{}t^{2}}+2\left(\frac{\dot a}{a}\right)\frac{\d\delta}{\d{}t}-\delta\left(4\pi\symup{G}\rho_{0}-k^{2}c_{\text{s}}^{2}\right)=0.\label{6.5.4}
\end{align}
...
辐射主导时，
\begin{equation}
\frac{\d{}^{2}\delta}{\d{}t^{2}}+2\left(\frac{\dot a}{a}\right)\frac{\d\delta}{\d{}t}-\delta\left(\frac{32}{3}\pi\symup{G}\rho-k^{2}c_{\text{s}}^{2}\right)=0.
\end{equation}
