...
因此
\begin{equation}
\tau=\left(\frac{32\pi\symup{G}}{3\symup{c}^{2}}U\right)^{-\frac{1}{2}}\sim T_{10}^{-2}\,\unit{s}.
\end{equation}
...
\begin{equation}
\chi\left(z\right)=\qty{3.4e-3}{}\frac{\left(\Omega_{\mathrm{m}}h_{70}^{2}\right)^{\frac{1}{2}}}{\Omega_{\mathrm{b}}h_{70}^{2}}\left(\frac{z}{1000}\right)^{12.75}=0.04\left(\frac{z}{1000}\right)^{12.75},
\end{equation}
计算光深
\begin{equation}
\tau\left(z\right)=\int_{0}^{z}n_{{\color{blue}{\ce{e}}}}\left(z\right)\chi\left(z\right)\sigma_{\mathrm{T}}\frac{\d{}l}{\d{}z}\d{}z.
\end{equation}
...
\begin{equation}
P'\left(z\right)\d{}z=-\frac{\d{}P}{\d{}z}\d{}z=\symup{e}^{-\tau}\frac{\d\tau}{\d{}z}\d{}z.
\end{equation}
...
\begin{align}
\delta\left(\vec{x}\right)&=\frac{1}{\left(2\pi\right)^{\frac{3}{2}}}\int\delta\left(\vec{k}\right)\symup{e}^{-i\symbf{k}\cdot\symbf{x}}\d{}^{3}\vec{k}.\\
\delta\left(\vec{k}\right)&=\frac{1}{\left(2\pi\right)^{\frac{3}{2}}}\int\delta\left(\vec{x}\right)\symup{e}^{i\symbf{k}\cdot\symbf{x}}\d{}^{3}\vec{x}.
\end{align}
定义物质扰动满足
\begin{align}
&\frac{\delta\rho}{\rho_{0}}=\delta\left(t\right)\symup{e}^{i\symbf{k}\cdot\symbf{r}}.\\
&\frac{\d{}^{2}\delta}{\d{}t^{2}}+2\left(\frac{\dot a}{a}\right)\frac{\d\delta}{\d{}t}-\delta\left(4\pi\symup{G}\rho_{0}-k^{2}\symup{c}_{\mathrm{s}}^{2}\right)=0.\label{6.5.4}
\end{align}
...
\begin{equation}
\delta_{k}=\delta_{k, 0}\left(\frac{t}{t_{0}}\right)^{\frac{2}{3}}=\delta_{k, 0}\left(\frac{a}{a_{0}}\right).
\end{equation}
...
辐射主导时，
\begin{equation}
\frac{\d{}^{2}\delta}{\d{}t^{2}}+2\left(\frac{\dot a}{a}\right)\frac{\d\delta}{\d{}t}-\delta\left(\frac{32}{3}\pi\symup{G}\rho-k^{2}\symup{c}_{\mathrm{s}}^{2}\right)=0.
\end{equation}
考虑到 $a\propto\tau^{\frac{1}{2}}$,
\begin{equation}
\delta_{k}=\delta_{0}\left(\frac{a}{a_{0}}\right)^{2}.
\end{equation}
