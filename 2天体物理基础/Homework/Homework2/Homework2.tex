...
\noindent Hint: in thermal equilibrium $\dfrac{1}{2}mv^{2}=\dfrac{3}{2}k_{\symup{B}}T$.
...
\begin{align}
f\left(v\right)\d{}v&=\left(\frac{m}{2\pi{}k_{\symup{B}}T}\right)^{\frac{3}{2}}\exp\left(-\frac{mv^{2}}{2k_{\symup{B}}T}\right)4\pi{}v^{2}\d{}v.\tag{1}\\
\langle{}v^{2}\rangle&=\frac{\int_{0}^{\infty}v^{2}Nf\left(v\right)\d{}v}{N}=\frac{3k_{\symup{B}}T}{m_{\ce{H2}}},\tag{2}\\
...
\begin{align}
\laplacian{}t_{\symup{c}}&=\frac{1}{f}=\frac{1}{n\sigma}\sqrt{\frac{\pi{}m_{\ce{H2}}}{8k_{\symup{B}}T}}\notag\\
...
\noindent Consider two self-gravitating spheres with mass and radius $M$ and $R$. Sphere A has a uniform density and sphere B has a density that increases towards the centre as $\rho\left(r\right)=\rho_{\symup{c}}\left(1-r/R\right)$. Answer questions (a) and (b) for both spheres.
...
&=\int_{0}^{r}4\pi{}r^{2}\rho_{\symup{c}}\left(1-\frac{r}{R}\right)\d{}r\notag\\
&=4\pi\rho_{\symup{c}}\left(\frac{1}{3}r^{3}-\frac{1}{4}\frac{r^{4}}{R}\right).\tag{2}\\
M_{\text{B}}&=\frac{1}{3}\pi{}r_{\symup{c}}R^{3},\notag\\
\rho_{\symup{c}}&=\frac{3M}{\pi R^{3}},\tag{3}
\end{align}
the gravitational potential energy is
\begin{align}
U_{\text{B}}&=\int_{0}^{R}-\frac{\symup{G}M_{r\text{B}}}{r}4\pi\rho_{r}r^{2}\d{}r\notag\\
&=\int_{0}^{R}-16\symup{G}\pi^{2}\rho_{\symup{c}}^{2}\left(\frac{1}{3}r^{3}-\frac{1}{4}\frac{r^{4}}{R}\right)\left(1-\frac{r}{R}\right)r\d{}r\notag\\
&=-16\symup{G}\pi^{2}\rho_{\symup{c}}^{2}\left.\left(\frac{1}{15}r^{5}-\frac{7}{72}\frac{r^{6}}{R}+\frac{1}{28}\frac{r^{7}}{R^{2}}\right)\right\vert_{0}^{R}\notag\\
&=-\frac{26}{315}\symup{G}\pi^{2}\rho_{\symup{c}}^{2}R^{5}\notag\\
...
P\left(r\right)&=\int_{R}^{r}-\frac{\symup{G}M_{r\text{A}}}{r^{2}}\rho\d{}r\notag\\
&=\int_{R}^{r}-\frac{4}{3}\symup{G}\pi\rho^{2}r\d{}r\notag\\
&=\frac{2}{3}\symup{G}\pi\rho^{2}\left(R^{2}-r^{2}\right)\notag\\
&=\frac{3}{8}\frac{\symup{G}M^{2}}{\pi{}R^{6}}\left(R^{2}-r^{2}\right).\tag{1}
\end{align}
When $r=0$,
\begin{equation}
P_{\symup{c}\text{A}}=\frac{3}{8}\frac{\symup{G}M^{2}}{\pi{}R^{4}}.\tag{2}
\end{equation}

For sphere B
\begin{align}
P\left(r\right)&=\int_{R}^{r}-\frac{\symup{G}M_{r\text{B}}}{r^{2}}\rho_{r}\d{}r\notag\\
&=\int_{R}^{r}-4\symup{G}\pi\rho_{\symup{c}}^{2}\left(\frac{1}{3}r-\frac{1}{4}\frac{r^{2}}{R}\right)\left(1-\frac{r}{R}\right)\d{}r\notag\\
&=-\symup{G}\pi\rho_{\symup{c}}^{2}\left(\frac{2}{3}r^{2}-\frac{7}{9}\frac{r^{3}}{R}+\frac{1}{4}\frac{r^{4}}{R^{2}}-\frac{5}{36}R^{2}\right).\tag{3}
\end{align}
When $r=0$,
\begin{equation}
P_{\symup{c}\text{B}}=\frac{5}{36}\symup{G}\pi\rho_{\symup{c}}^{2}R^{2}=\frac{5}{4}\frac{\symup{G}M^{2}}{\pi{}R^{4}}.\tag{4}
\end{equation}
...
Radiation pressure
\begin{equation}
P_{\symup{rad}}=\frac{1}{3}a_{\symup{B}}T^{4}=\qty{1.65e13}{W\cdot{}m^{-2}}.\tag{1}
\end{equation}

Gas pressure
\begin{align}
P_{\symup{gas}}&=\frac{\rho}{\mu{}m_{\ce{H}}}k_{\symup{B}}T=\frac{\rho}{m_{\ce{H}}}k_{\symup{B}}T\left(2X+\frac{3}{4}Y\right)\notag\\
&=\qty{3.22e16}{W\cdot{}m^{-2}}.\tag{2}
\end{align}

Ratio
\begin{equation}
\frac{P_{\symup{rad}}}{P_{\symup{gas}}}\sim\qty{5e-4}{}.\tag{3}
\end{equation}
...
\noindent\textcolor{purple}{Solution}
\begin{align}
a&=\frac{\symup{G}M_{\symup{Earth}}}{r^{2}}\notag\\
M_{\symup{Earth}}&=\frac{a\left(\dfrac{l}{2\pi}\right)^{2}}{\symup{G}}=\qty{6e24}{kg}.\tag{1}
\end{align}

\hspace*{\fill}

\noindent\textcolor{purple}{(b)} Starting from the basic equation for hydrostatical support $\dfrac{\d{}P}{\d{}r}=-\dfrac{\symup{G}M\rho}{r^{2}}$, show that you can express the derivative of $\dfrac{\d{}P}{\d\tau}$ (where $\tau$ is the optical depth) simply in terms of the ratio of the surface gravity $g\left(r\right)$ and the opacity $\chi$.

\hspace*{\fill}

\noindent\textcolor{purple}{Solution}
\begin{align}
\frac{\d{}P}{\d\tau}=\frac{\d{}P}{\d{}r}\frac{\d{}r}{\d\tau}=\frac{\d{}P}{\d{}r}\frac{1}{\rho\chi}=\frac{g\left(r\right)}{\chi}.\tag{1}
\end{align}
...
\noindent\textcolor{purple}{Solution}
\begin{align}
L&=4\pi{}R^{2}\sigma_{\symup{SB}}T^{4},\notag\\
...
\noindent\textcolor{purple}{Solution}
\begin{equation}
n=n_{\nu}\times\frac{\pi\times\left(\qty{0.25}{m}\right)^{2}}{4\pi\times\left(\qty{51.4}{kpc}\right)^{2}}=\qty{1.1e13}{}.\tag{1}
\end{equation}
...
\noindent Hint: for a relativistic particle, use the relation $D=vt$ where $D$ is the distance, $t$ the travel time and $v=\symup{c}\sqrt{1-\dfrac{1}{\gamma^{2}}}$ the speed, with $\gamma$ the Lorentz factor. Also use the first approximation of the binomial expansion $\left(1+x\right)^{n}=1-nx$.

\hspace*{\fill}

\noindent\textcolor{purple}{Solution}
\begin{align}
\laplacian{}t&=\frac{D}{v_{1}}-\frac{D}{v_{2}}=\frac{D}{\symup{c}}\left(1-\frac{1}{2}\gamma_{1}^{-2}-1+\frac{1}{2}\gamma_{2}^{-2}\right)\notag\\
&=\frac{D}{2}m_{0}^{2}\symup{c}^{3}\left(\frac{1}{E_{1}^{2}}-\frac{1}{E_{2}^{2}}\right)=E_{0}^{2}\frac{D}{2\symup{c}}\left(\frac{1}{E_{1}^{2}}-\frac{1}{E_{2}^{2}}\right).\tag{3}\\
...
\noindent\textcolor{purple}{Solution}
\begin{align}
M_{\symup{planet}}\ge{}v_{1}M_{1}^{\frac{2}{3}}\left(\frac{T}{2\pi\symup{G}}\right)^{\frac{1}{3}}=\qty{0.7}{M_{\symup{Jupiter}}}.\tag{1}\\
r_{\symup{planet}}=\symup{G}M_{1}^{-1}M_{\symup{planet}}^{2}v_{1}^{-2}=\qty{0.047}{AU}.\tag{2}
\end{align}
...
In fact
\begin{equation}
M_{\symup{planet}}\sin{i}=v_{1,\symup{obs}}M_{1}^{\frac{2}{3}}\left(\frac{T}{2\pi \symup{G}}\right)^{\frac{1}{3}}.\tag{1}
\end{equation}
...
\noindent\textcolor{purple}{Solution}
\begin{align}
R_{\symup{planet}}&\sim\sqrt{1.3\%}\times\qty{1.2}{R_{\odot}}=\qty{9.52685e7}{m}.\notag\\
\rho&=\frac{M_{\symup{planet}}}{\dfrac{4}{3}\pi{}R_{\symup{planet}}^{3}}=\qty{364.37}{kg\cdot{}m^{-3}}.\tag{1}
\end{align}
...
\begin{equation}
N=n_{\symup{BH}}\omega\cdot{}\left(2\beta\right)\cdot{}n_{\symup{stars}}\cdot{}\qty{40}{deg^{2}}\cdot{}\qty{1}{yr}=1.33.\tag{3}
\end{equation}
...
\begin{equation}
U_{\symup{tidal}}=-\dfrac{\symup{G}M_{\symup{Moon}}m}{2r^{3}}R^{2}\left(3\cos^{2}{\phi}-1\right),\notag
\end{equation}
...
\noindent\textcolor{purple}{Solution}
\begin{align}
&-\frac{\symup{G}M_{\symup{Moon}}}{2r^{3}}R^{2}\left(3-1-0+1\right)\notag\\
&=-\frac{\symup{G}M_{\symup{Earth}}}{R}+\frac{\symup{G}M_{\symup{Earth}}}{R+h},\notag\\
&h=\frac{3M_{\symup{Moon}}R^{4}}{2M_{\symup{Earth}}r^{3}}=\qty{0.535}{m}.\tag{1}
\end{align}
...
\noindent\textcolor{purple}{Solution}
\begin{equation}
h_{\odot}=\frac{3M_{\odot}R^{4}}{2M_{\symup{Earth}}\left(\qty{1}{AU}\right)^{3}}=\qty{0.247}{m}.\tag{2}
\end{equation}
...
\noindent Detecting Earth-like ($T\approx\qty{300}{K}, M\approx{}M_{\symup{Earth}}$) extrasolar planets is a major goal of modern astrophysics. In the case of our Sun, the radial velocity (RV)-signal due to the gravitational interaction with the Earth is very small ($\sim\qty{0.09}{m\cdot{}s^{-1}}$) and below the sensitivity of current instrumentation.
...
Note that
\begin{equation}
V_{\symup{obs}}=\symup{G}^{\frac{1}{2}}M_{1}^{-\frac{1}{2}}M_{\symup{p}}r_{\symup{p}}^{-\frac{1}{2}}\sin{i}.\tag{1}
\end{equation}
With $M_{1}=\qty{0.3}{M_{\odot}}, r_{\symup{p}}=\qty{0.2}{AU}$,
\begin{equation}
V_{\symup{obs}}=\qty{0.09}{m\cdot{}s^{-1}}\times0.3^{-\frac{1}{2}}\times0.2^{-\frac{1}{2}}\times\sin{i}.\tag{2}
\end{equation}
$i=\ang{90;;}, V_{\symup{obs}}=\qty{0.367}{m\cdot{}s^{-1}}$.

\noindent $i=\ang{60;;}, V_{\symup{obs}}=\qty{0.318}{m\cdot{}s^{-1}}$.

\noindent $i=\ang{30;;}, V_{\symup{obs}}=\qty{0.183}{m\cdot{}s^{-1}}$.

\noindent $i=\ang{0;;}, V_{\symup{obs}}=\qty{0}{m\cdot{}s^{-1}}$.
...
1. For low-mass stars, in order to receive the same intensity of light as Earth does from the Sun, the distance between the planet and the star must be relatively small. As $V_{\symup{obs}}\propto{}M_{S}^{-\frac{1}{2}}, V_{\symup{obs}}\propto{}r_{\symup{p}}^{-\frac{1}{2}}$, the RV-signal is easier to detect.
...
\noindent\textcolor{purple}{Solution}
\begin{align}
M_{\symup{J}}&=\frac{1}{6}\pi\rho\lambda_{\symup{J}}^{3}=\frac{1}{6}\pi^{\frac{5}{2}}\symup{G}^{-\frac{3}{2}}\rho^{-\frac{1}{2}}\symup{c}_{\symup{s}}^{3},\tag{1}\\
\symup{c}_{\symup{s}}&\sim{}v_{\symup{rms}}=\sqrt{\dfrac{3k_{\symup{B}}T}{m_{\ce{H2}}}},\tag{2}\\
M_{\symup{J}}&=\frac{1}{6}\pi^{\frac{5}{2}}\symup{G}^{-\frac{3}{2}}\left(n_{\ce{H2}}m_{\ce{H2}}\right)^{-\frac{1}{2}}\left(\dfrac{3k_{\symup{B}}T}{m_{\ce{H2}}}\right)^{\frac{3}{2}}\notag\\
&=\qty{4e31}{kg}.\tag{3}
\end{align}
...
\noindent\textcolor{purple}{Solution}
\begin{align}
M_{\symup{J}}&=\frac{1}{6}\pi^{\frac{5}{2}}\symup{G}^{-\frac{3}{2}}\rho^{-\frac{1}{2}}\left(\dfrac{3k_{\symup{B}}T}{m_{\ce{H}}}\right)^{\frac{3}{2}}\notag\\
&=\qty{4.5e36}{kg}.\tag{1}
\end{align}
