...
\begin{align}
f\mleft(v\mright)\d{}v&=\mleft(\frac{m}{2\pi{}\symup{k}_{\mathrm{B}}T}\mright)^{\frac{3}{2}}\exp\mleft(-\frac{mv^{2}}{2\symup{k}_{\mathrm{B}}T}\mright) 4\pi{}v^{2}\d{}v.\tag{1}\\
\langle{}v^{2}\rangle&=\frac{\int_{0}^{\infty}v^{2}Nf\mleft(v\mright)\d{}v}{N}=\frac{3\symup{k}_{\mathrm{B}}T}{m_{\ce{H2}}},\tag{2}\\
...
Gas pressure
\begin{align}
P_{\mathrm{gas}}&=\frac{\rho}{\mu{}m_{\ce{H}}}\symup{k}_{\mathrm{B}}T=\frac{\rho}{m_{\ce{H}}}\symup{k}_{\mathrm{B}}T\mleft(2X+\frac{3}{4}Y\mright)\notag\\
...
M_{\mathrm{J}}&=\frac{1}{6}\pi^{\frac{5}{2}}\symup{G}^{-\frac{3}{2}}\mleft(n_{\ce{H2}}m_{\ce{H2}}\mright)^{-\frac{1}{2}}\mleft(\dfrac{3\symup{k}_{\mathrm{B}}T}{m_{\ce{H2}}}\mright)^{\frac{3}{2}}\notag\\
&=\qty{4e31}{kg}.\tag{3}
\end{align}
...
\noindent\textcolor{purple}{Solution}
\begin{align}
M_{\mathrm{J}}&=\frac{1}{6}\pi^{\frac{5}{2}}\symup{G}^{-\frac{3}{2}}\rho^{-\frac{1}{2}}\mleft(\dfrac{3\symup{k}_{\mathrm{B}}T}{m_{\ce{H}}}\mright)^{\frac{3}{2}}\notag\\
&=\qty{4.5e36}{kg}.\tag{1}
\end{align}
