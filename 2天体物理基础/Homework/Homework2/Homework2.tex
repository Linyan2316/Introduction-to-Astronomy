...
\noindent Hint: in thermal equilibrium $\dfrac{1}{2}mv^{2}=\dfrac{3}{2}\symup{k}_{\mathrm{B}}T$.
...
\begin{align}
f\left(v\right)\d{}v&=\left(\frac{m}{2\pi{}\symup{k}_{\mathrm{B}}T}\right)^{\frac{3}{2}}\exp\left(-\frac{mv^{2}}{2\symup{k}_{\mathrm{B}}T}\right)4\pi{}v^{2}\d{}v.\tag{1}\\
\langle{}v^{2}\rangle&=\frac{\int_{0}^{\infty}v^{2}Nf\left(v\right)\d{}v}{N}=\frac{3\symup{k}_{\mathrm{B}}T}{m_{\ce{H2}}},\tag{2}\\
\sqrt{\langle{}v^{2}\rangle}&=\sqrt{\frac{3\symup{k}_{\mathrm{B}}T}{m_{\ce{H2}}}}=\qty{1112.7}{km\cdot{}s^{-1}}.\tag{3}
\end{align}
...
\begin{equation}
\overline{v}=\sqrt{\frac{8\symup{k}_{\mathrm{B}}T}{\pi{}m_{\ce{H2}}}},\tag{1}
\end{equation}
...
\begin{align}
\laplacian{}t_{\mathrm{c}}&=\frac{1}{f}=\frac{1}{n\sigma}\sqrt{\frac{\pi{}m_{\ce{H2}}}{8\symup{k}_{\mathrm{B}}T}}\notag\\
...
\noindent Consider two self-gravitating spheres with mass and radius $M$ and $R$. Sphere A has a uniform density and sphere B has a density that increases towards the centre as $\rho\left(r\right)=\rho_{\mathrm{c}}\left(1-r/R\right)$. Answer questions (a) and (b) for both spheres.
...
&=\int_{0}^{r}4\pi{}r^{2}\rho_{\mathrm{c}}\left(1-\frac{r}{R}\right)\d{}r\notag\\
&=4\pi\rho_{\mathrm{c}}\left(\frac{1}{3}r^{3}-\frac{1}{4}\frac{r^{4}}{R}\right).\tag{2}\\
...
&=\int_{0}^{R}-16\symup{G}\pi^{2}\rho_{\mathrm{c}}^{2}\left(\frac{1}{3}r^{3}-\frac{1}{4}\frac{r^{4}}{R}\right)\left(1-\frac{r}{R}\right)r\d{}r\notag\\
&=-16\symup{G}\pi^{2}\rho_{\mathrm{c}}^{2}\left.\left(\frac{1}{15}r^{5}-\frac{7}{72}\frac{r^{6}}{R}+\frac{1}{28}\frac{r^{7}}{R^{2}}\right)\right\vert_{0}^{R}\notag\\
...
&=\int_{R}^{r}-4\symup{G}\pi\rho_{\mathrm{c}}^{2}\left(\frac{1}{3}r-\frac{1}{4}\frac{r^{2}}{R}\right)\left(1-\frac{r}{R}\right)\d{}r\notag\\
&=-\symup{G}\pi\rho_{\mathrm{c}}^{2}\left(\frac{2}{3}r^{2}-\frac{7}{9}\frac{r^{3}}{R}+\frac{1}{4}\frac{r^{4}}{R^{2}}-\frac{5}{36}R^{2}\right).\tag{3}
\end{align}
When $r=0$,
\begin{equation}
...
Gas pressure
\begin{align}
P_{\mathrm{gas}}&=\frac{\rho}{\mu{}m_{\ce{H}}}\symup{k}_{\mathrm{B}}T=\frac{\rho}{m_{\ce{H}}}\symup{k}_{\mathrm{B}}T\left(2X+\frac{3}{4}Y\right)\notag\\
...
M_{\mathrm{Earth}}&=\frac{a\left(\dfrac{l}{2\pi}\right)^{2}}{\symup{G}}=\qty{6e24}{kg}.\tag{1}
\end{align}
...
\noindent\textcolor{purple}{Solution}
\begin{align}
M_{\mathrm{planet}}\ge{}v_{1}M_{1}^{\frac{2}{3}}\left(\frac{T}{2\pi\symup{G}}\right)^{\frac{1}{3}}=\qty{0.7}{M_{\mathrm{Jupiter}}}.\tag{1}\\
...
In fact
\begin{equation}
M_{\mathrm{planet}}\sin{i}=v_{1,\mathrm{obs}}M_{1}^{\frac{2}{3}}\left(\frac{T}{2\pi \symup{G}}\right)^{\frac{1}{3}}.\tag{1}
\end{equation}
...
\noindent\textcolor{purple}{Solution}
\begin{align}
&a_{\mathrm{total}}=\frac{u^{2}+2}{u\left(u^{2}+4\right)^{\frac{1}{2}}}, u=\frac{\beta}{\theta_{\mathrm{E}}},\notag\\
...
\begin{equation}
N=n_{\mathrm{BH}}\omega\cdot{}\left(2\beta\right)\cdot{}n_{\mathrm{stars}}\cdot{}\qty{40}{deg^{2}}\cdot{}\qty{1}{yr}=1.33.\tag{3}
\end{equation}
...
\begin{equation}
U_{\mathrm{tidal}}=-\dfrac{\symup{G}M_{\mathrm{Moon}}m}{2r^{3}}R^{2}\left(3\cos^{2}{\phi}-1\right),\notag
\end{equation}
...
\noindent\textcolor{purple}{Solution}
\begin{align}
&-\frac{\symup{G}M_{\mathrm{Moon}}}{2r^{3}}R^{2}\left(3-1-0+1\right)\notag\\
...
\noindent\textcolor{purple}{Solution}
\begin{equation}
h_{\odot}=\frac{3M_{\odot}R^{4}}{2M_{\mathrm{Earth}}\left(\qty{1}{AU}\right)^{3}}=\qty{0.247}{m}.\tag{2}
\end{equation}
...
\noindent\textcolor{purple}{Solution}
\begin{align}
M_{\mathrm{J}}&=\frac{1}{6}\pi\rho\lambda_{\mathrm{J}}^{3}=\frac{1}{6}\pi^{\frac{5}{2}}\symup{G}^{-\frac{3}{2}}\rho^{-\frac{1}{2}}\symup{c}_{\mathrm{s}}^{3},\tag{1}\\
\symup{c}_{\mathrm{s}}&\sim{}v_{\mathrm{rms}}=\sqrt{\dfrac{3\symup{k}_{\mathrm{B}}T}{m_{\ce{H2}}}},\tag{2}\\
M_{\mathrm{J}}&=\frac{1}{6}\pi^{\frac{5}{2}}\symup{G}^{-\frac{3}{2}}\left(n_{\ce{H2}}m_{\ce{H2}}\right)^{-\frac{1}{2}}\left(\dfrac{3\symup{k}_{\mathrm{B}}T}{m_{\ce{H2}}}\right)^{\frac{3}{2}}\notag\\
&=\qty{4e31}{kg}.\tag{3}
\end{align}
...
\noindent\textcolor{purple}{Solution}
\begin{align}
M_{\mathrm{J}}&=\frac{1}{6}\pi^{\frac{5}{2}}\symup{G}^{-\frac{3}{2}}\rho^{-\frac{1}{2}}\left(\dfrac{3\symup{k}_{\mathrm{B}}T}{m_{\ce{H}}}\right)^{\frac{3}{2}}\notag\\
&=\qty{4.5e36}{kg}.\tag{1}
\end{align}
