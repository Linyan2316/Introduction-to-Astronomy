...
\begin{equation}
\rho_{\mathrm{c}}=\frac{3H\left(t\right)^{2}}{8\pi\symup{G}}.\notag
\end{equation}
...
\rho_{\mathrm{cri}}&=\frac{3H\left(t\right)^{2}}{8\pi\symup{G}}.\tag{2}
\end{align}
...
\noindent\textcolor{purple}{Solution}
\begin{align}
\rho_{\mathrm{cri}}&=\frac{3H\left(t\right)^{2}}{8\pi\symup{G}}=\qty{9.2e-27}{kg\cdot{}m^{-3}}\tag{1}\\
