...
\begin{align}
M-M_{\mathrm{abs}}&=-2.5\log_{10}\mleft(\frac{f}{f_{\mathrm{abs}}}\mright)\notag\\
&=-2.5\log_{10}\mleft(\frac{\qty{10}{pc}}{\qty{50}{kpc}}\mright)^{2}.\tag{1}\\
...
Use $r=\dfrac{L}{\cos{\theta}}$, $\hat{r}\cdot{}\hat{n}=\cos{\theta}$ and $A=\pi\mleft(\dfrac{d}{2}\mright)^{2}$, we can obtain that
\begin{align}
F_{\nu}&=I_{\nu}\cos{\theta}\frac{\cos^{3}{\theta}}{L^{2}}\int{}\d{}A\notag\\
&=\frac{\pi{}d^{2}\cos^{4}{\theta}}{4L^{2}}I_{\nu}\mleft(\theta,\phi\mright).\tag{3}
\end{align}
...
\begin{equation}
\alpha=n_{{\color{blue}{\ce{e}}}}\sigma_{\mathrm{T}}.\tag{1}
\end{equation}
...
\begin{equation}
\alpha=n_{{\color{blue}{\ce{e}}}}\sigma_{\mathrm{T}}=\qty{2.15e-4}{cm^{-1}}.\tag{3}
\end{equation}
Thus
\begin{align}
