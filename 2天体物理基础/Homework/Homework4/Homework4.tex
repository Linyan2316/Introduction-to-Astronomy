...
\begin{align}
\rho\mleft(r, z\mright)&=\rho_{0}\symup{e}^{-\frac{\mleft\vert{}r\mright\vert}{r_{0}}}\symup{e}^{-\frac{\mleft\vert{}z\mright\vert}{z_{0}}}.\tag{1}\\
...
\Sigma\mleft(r\mright)&=2\int_{0}^{\infty}\rho\mleft(r, z\mright)\d{}z\notag\\
...
\noindent\textcolor{purple}{Solution}
\begin{align}
\Sigma\mleft(r\mright)&=\rho_{\text{water}}h\mleft(r\mright),\notag\\
h\mleft(r\mright)&=2z_{0}\frac{\rho_{0}}{\rho_{\text{water}}}\symup{e}^{-\frac{r}{r_{0}}}.\tag{1}
\end{align}
...
\eta\mleft(r\mright)&=1-\frac{\Sigma\mleft(r\mright)}{\Sigma_{\odot}}=1-2.1\times10^{-12}\symup{e}^{-\frac{r}{r_{0}}}.\tag{2}
\end{align}
...
\begin{align}
\oint_{S}\symbf{F}_{\mathrm{g}1}\cdot\d{}\symbf{S}&=-2F_{\mathrm{g}1}S=-4\pi\symup{G}S\mleft(h-z\mright)\rho.\tag{2}\\
\oint_{S}\symbf{F}_{\mathrm{g}2}\cdot\d{}\symbf{S}&=-2F_{\mathrm{g}2}S=-4\pi\symup{G}S\mleft(h+z\mright)\rho.\tag{3}\\
